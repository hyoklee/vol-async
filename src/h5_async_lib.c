...
static int async_setup(void) {
  ...
  if (-1 == async_file_wait_op_g) {
    if (H5VLfind_opt_operation(H5VL_SUBCLS_FILE, H5VL_ASYNC_DYN_FILE_WAIT,
                               &async_file_wait_op_g) < 0) {
      fprintf(stderr, "  [ASYNC VOL ERROR] with H5VLfind_opt_operation\n");
      return (-1);
    }
  ...
  if (-1 == async_file_start_op_g) {
    if (H5VLfind_opt_operation(H5VL_SUBCLS_FILE, H5VL_ASYNC_DYN_FILE_START,
                               &async_file_start_op_g) < 0) {
      fprintf(stderr, "  [ASYNC VOL ERROR] with H5VLfind_opt_operation\n");
      return (-1);
    }
  ...
  if (-1 == async_file_pause_op_g) {
    if (H5VLfind_opt_operation(H5VL_SUBCLS_FILE, H5VL_ASYNC_DYN_FILE_PAUSE,
                               &async_file_pause_op_g) < 0) {
      fprintf(stderr, "  [ASYNC VOL ERROR] with H5VLfind_opt_operation\n");
      return (-1);
    }
  ...
  if (-1 == async_file_delay_op_g) {
    if (H5VLfind_opt_operation(H5VL_SUBCLS_FILE, H5VL_ASYNC_DYN_FILE_DELAY,
                               &async_file_delay_op_g) < 0) {
      fprintf(stderr, "  [ASYNC VOL ERROR] with H5VLfind_opt_operation\n");
      return (-1);
    }
  ...
  if (-1 == async_request_start_op_g) {
    if (H5VLfind_opt_operation(H5VL_SUBCLS_REQUEST,
  ...
  if (-1 == async_request_dep_op_g) {
    if (H5VLfind_opt_operation(H5VL_SUBCLS_REQUEST, H5VL_ASYNC_DYN_REQUEST_DEP,
                               &async_request_dep_op_g) < 0) {
      fprintf(stderr, "  [ASYNC VOL ERROR] with H5VLfind_opt_operation\n");
      return (-1);
    }
...
herr_t H5Fwait(hid_t file_id, hid_t dxpl_id) {
  ...
  if (H5VLfile_optional_op(file_id, &vol_cb_args, dxpl_id, H5ES_NONE) < 0) {
    fprintf(stderr,
            "  [ASYNC VOL ERROR] H5Fwait: VOL connector file wait operation\n");
    return (-1);
  }
...
herr_t H5Dwait(hid_t dset_id, hid_t dxpl_id) {
  ...
  if (H5VLdataset_optional_op(dset_id, &vol_cb_args, dxpl_id, H5ES_NONE) < 0) {
    fprintf(
        stderr,
        "  [ASYNC VOL ERROR] H5Dwait: VOL connector dataset wait operation\n");
    return (-1);
  }
...
herr_t H5Fstart(hid_t file_id, hid_t dxpl_id) {
  ...
  /* Call the VOL file optional routine, requesting 'wait' occur */
  if (H5VLfile_optional_op(file_id, &vol_cb_args, dxpl_id, H5ES_NONE) < 0) {
    fprintf(stderr, "  [ASYNC VOL ERROR] H5Fstart: VOL connector file start "
                    "operation failed!\n");
    return (-1);
  }
...
herr_t H5Dstart(hid_t dset_id, hid_t dxpl_id) {
  ...
  if (H5VLdataset_optional_op(dset_id, &vol_cb_args, dxpl_id, H5ES_NONE) < 0) {
    fprintf(stderr, "  [ASYNC VOL ERROR] H5Dstart: VOL connector dset start "
                    "operation failed!\n");
    return (-1);
  }
 ...
 *-------------------------------------------------------------------------
 */
herr_t H5Fpause(hid_t file_id, hid_t dxpl_id) {
  H5VL_optional_args_t vol_cb_args; /* Arguments to VOL callback */
  ...
  /* Call the VOL file optional routine, requesting 'wait' occur */
  if (H5VLfile_optional_op(file_id, &vol_cb_args, dxpl_id, H5ES_NONE) < 0) {
    fprintf(stderr, "  [ASYNC VOL ERROR] H5Fpause: VOL connector file pause "
                    "operation failed!\n");
    return (-1);
  }
 ...
 *-------------------------------------------------------------------------
 */
herr_t H5Dpause(hid_t dset_id, hid_t dxpl_id) {
  H5VL_optional_args_t vol_cb_args; /* Arguments to VOL callback */
  ...
  /* Call the VOL dset optional routine, requesting 'wait' occur */
  if (H5VLdataset_optional_op(dset_id, &vol_cb_args, dxpl_id, H5ES_NONE) < 0) {
    fprintf(stderr, "  [ASYNC VOL ERROR] H5Dpause: VOL connector dset pause "
                    "operation failed!\n");
    return (-1);
  }
 ...
 *-------------------------------------------------------------------------
 */
herr_t H5Fset_delay_time(hid_t file_id, hid_t dxpl_id, uint64_t time_us) {
  H5VL_optional_args_t vol_cb_args;   /* Arguments to VOL callback */
  ...
  if (H5VLfile_optional_op(file_id, &vol_cb_args, dxpl_id, H5ES_NONE) < 0) {
    fprintf(stderr,
            "  [ASYNC VOL ERROR] %s: VOL connector set file delay operation "
            "failed!\n",
            __func__);
    return (-1);
  }
 ...
 *-------------------------------------------------------------------------
 */
herr_t H5Dset_delay_time(hid_t dset_id, hid_t dxpl_id, uint64_t time_us) {
  H5VL_optional_args_t vol_cb_args;   /* Arguments to VOL callback */
  H5VL_async_delay_args_t delay_args; /* Arguments for optional operation */
  ...
  if (H5VLdataset_optional_op(dset_id, &vol_cb_args, dxpl_id, H5ES_NONE) < 0) {
    fprintf(stderr,
            "  [ASYNC VOL ERROR] %s: VOL connector set dset delay operation "
            "failed!\n",
            __func__);
    return (-1);
  }
...
herr_t H5Pset_dxpl_disable_async_implicit(hid_t dxpl, hbool_t is_disable) {
  ...
  if (status < 0) {
    ...
    status = H5Pinsert2(dxpl, H5VL_ASYNC_DISABLE_IMPLICIT_NAME, sizeof(hbool_t),
                        &is_disable, NULL, NULL, NULL, NULL, NULL, NULL);
    if (status < 0) {
...
herr_t H5Pset_dxpl_pause(hid_t dxpl, hbool_t is_pause) {
  ...
  if (status < 0) {
    ...
    status = H5Pinsert2(dxpl, H5VL_ASYNC_PAUSE_NAME, sizeof(hbool_t), &is_pause,
...
herr_t H5async_start(void *request) {
  ...
  /* Call the VOL file optional routine, requesting 'wait' occur */
  if ((status = H5VLrequest_optional_op(request, H5VL_async_g, &vol_cb_args)) <
      0) {
    fprintf(stderr, "  [ASYNC VOL ERROR] H5async_start: VOL connector request "
...
herr_t H5async_set_request_dep(void *request, void *parent_request) {
  ...
  if ((status = H5VLrequest_optional_op(request, H5VL_async_g, &vol_cb_args)) <
      0) {
    fprintf(stderr, "  [ASYNC VOL ERROR] H5async_set_request_dep: VOL "
                    "connector request depend operation failed!\n");
    return (-1);
  }
...
herr_t H5Pset_dxpl_delay(hid_t dxpl, uint64_t time_us) {
  ...
  if (status < 0) {
    ...
    status = H5Pinsert2(dxpl, H5VL_ASYNC_DELAY_NAME, sizeof(uint64_t), &time_us,
                        NULL, NULL, NULL, NULL, NULL, NULL);
    if (status < 0) {
      fprintf(stderr, "  [ASYNC VOL ERROR] %s: H5Pinsert2 failed!\n", __func__);
      return (-1);
...
herr_t H5Pset_fapl_disable_async_implicit(hid_t fapl, hbool_t is_disable) {
  ...
  if (status < 0) {
    ...
    status = H5Pinsert2(fapl, H5VL_ASYNC_DISABLE_IMPLICIT_NAME, sizeof(hbool_t),
                        &is_disable, NULL, NULL, NULL, NULL, NULL, NULL);
    if (status < 0) {
      fprintf(stderr, "  [ASYNC VOL ERROR] %s: H5Pinsert2 failed!\n", __func__);
      return (-1);
