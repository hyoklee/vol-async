...
const char *qtype_names_g[10] = {"QTYPE_NONE", "REGULAR",  "DEPENDENT",
...
typedef struct async_instance_t {
  ...
  int sleep_time; /* Sleep time between checking the global mutex attemp count
                   */
  uint64_t delay_time; /* Sleep time before background thread trying to acquire
                          global mutex */
#ifdef ENABLE_WRITE_MEMCPY
  hsize_t max_mem;
  hsize_t used_mem;
...
static herr_t H5VL_async_info_cmp(int *cmp_value, const void *info1,
                                  const void *info2);
...
static herr_t H5VL_async_attr_read(void *attr, hid_t mem_type_id, void *buf,
                                   hid_t dxpl_id, void **req);
static herr_t H5VL_async_attr_write(void *attr, hid_t mem_type_id,
                                    const void *buf, hid_t dxpl_id, void **req);
static herr_t H5VL_async_attr_get(void *obj, H5VL_attr_get_args_t *args,
                                  hid_t dxpl_id, void **req);
static herr_t H5VL_async_attr_specific(void *obj,
                                       const H5VL_loc_params_t *loc_params,
                                       H5VL_attr_specific_args_t *args,
                                       hid_t dxpl_id, void **req);
static herr_t H5VL_async_attr_optional(void *obj, H5VL_optional_args_t *args,
                                       hid_t dxpl_id, void **req);
...
static void *H5VL_async_dataset_open(void *obj,
                                     ...
                                     hid_t dxpl_id, void **req);
static herr_t H5VL_async_dataset_read(void *dset, hid_t mem_type_id,
                                      hid_t mem_space_id, hid_t file_space_id,
                                      hid_t plist_id, void *buf, void **req);
static herr_t H5VL_async_dataset_write(void *dset, hid_t mem_type_id,
                                       hid_t mem_space_id, hid_t file_space_id,
                                       hid_t plist_id, const void *buf,
                                       void **req);
static herr_t H5VL_async_dataset_get(void *dset, H5VL_dataset_get_args_t *args,
                                     hid_t dxpl_id, void **req);
static herr_t H5VL_async_dataset_specific(void *obj,
                                          H5VL_dataset_specific_args_t *args,
                                          hid_t dxpl_id, void **req);
static herr_t H5VL_async_dataset_optional(void *obj, H5VL_optional_args_t *args,
                                          hid_t dxpl_id, void **req);
...
static void *H5VL_async_datatype_open(void *obj,
                                      ...
                                      hid_t dxpl_id, void **req);
static herr_t H5VL_async_datatype_get(void *dt, H5VL_datatype_get_args_t *args,
                                      hid_t dxpl_id, void **req);
static herr_t H5VL_async_datatype_specific(void *obj,
                                           H5VL_datatype_specific_args_t *args,
                                           hid_t dxpl_id, void **req);
static herr_t H5VL_async_datatype_optional(void *obj,
                                           H5VL_optional_args_t *args,
                                           hid_t dxpl_id, void **req);
static herr_t H5VL_async_datatype_close(void *dt, hid_t dxpl_id, void **req);

/* File callbacks */
static void *H5VL_async_file_create(const char *name, unsigned flags,
                                    hid_t fcpl_id, hid_t fapl_id, hid_t dxpl_id,
                                    void **req);
static void *H5VL_async_file_open(const char *name, unsigned flags,
                                  hid_t fapl_id, hid_t dxpl_id, void **req);
static herr_t H5VL_async_file_get(void *file, H5VL_file_get_args_t *args,
                                  hid_t dxpl_id, void **req);
static herr_t H5VL_async_file_specific(void *file,
                                       H5VL_file_specific_args_t *args,
                                       hid_t dxpl_id, void **req);
static herr_t H5VL_async_file_optional(void *file, H5VL_optional_args_t *args,
                                       hid_t dxpl_id, void **req);
...
static void *H5VL_async_group_open(void *obj,
                                   ...
                                   hid_t dxpl_id, void **req);
static herr_t H5VL_async_group_get(void *obj, H5VL_group_get_args_t *args,
                                   hid_t dxpl_id, void **req);
static herr_t H5VL_async_group_specific(void *obj,
                                        H5VL_group_specific_args_t *args,
                                        hid_t dxpl_id, void **req);
static herr_t H5VL_async_group_optional(void *obj, H5VL_optional_args_t *args,
                                        hid_t dxpl_id, void **req);
...
static herr_t H5VL_async_link_specific(void *obj,
                                       ...
                                       H5VL_link_specific_args_t *args,
                                       hid_t dxpl_id, void **req);
static herr_t H5VL_async_link_optional(void *obj,
                                       const H5VL_loc_params_t *loc_params,
                                       H5VL_optional_args_t *args,
                                       hid_t dxpl_id, void **req);
...
static herr_t H5VL_async_object_specific(void *obj,
                                         ...
                                         H5VL_object_specific_args_t *args,
                                         hid_t dxpl_id, void **req);
static herr_t H5VL_async_object_optional(void *obj,
                                         const H5VL_loc_params_t *loc_params,
                                         H5VL_optional_args_t *args,
                                         hid_t dxpl_id, void **req);
...
static herr_t H5VL_async_introspect_get_cap_flags(const void *info,
                                                  unsigned *cap_flags);
static herr_t H5VL_async_introspect_opt_query(void *obj, H5VL_subclass_t cls,
                                              int opt_type, uint64_t *flags);

/* Async request callbacks */
static herr_t H5VL_async_request_wait(void *req, uint64_t timeout,
                                      H5VL_request_status_t *status);
static herr_t H5VL_async_request_notify(void *obj, H5VL_request_notify_t cb,
                                        void *ctx);
...
/* Blob callbacks */
static herr_t H5VL_async_blob_put(void *obj, const void *buf, size_t size,
                                  void *blob_id, void *ctx);
static herr_t H5VL_async_blob_get(void *obj, const void *blob_id, void *buf,
                                  size_t size, void *ctx);
static herr_t H5VL_async_blob_specific(void *obj, void *blob_id,
                                       H5VL_blob_specific_args_t *args);
static herr_t H5VL_async_blob_optional(void *obj, void *blob_id,
                                       H5VL_optional_args_t *args);

/* Token callbacks */
static herr_t H5VL_async_token_cmp(void *obj, const H5O_token_t *token1,
                                   const H5O_token_t *token2, int *cmp_value);
static herr_t H5VL_async_token_to_str(void *obj, H5I_type_t obj_type,
                                      const H5O_token_t *token,
                                      char **token_str);
static herr_t H5VL_async_token_from_str(void *obj, H5I_type_t obj_type,
                                        const char *token_str,
                                        H5O_token_t *token);

/* Generic optional callback */
static herr_t H5VL_async_optional(void *obj, H5VL_optional_args_t *args,
                                  hid_t dxpl_id, void **req);
...
static herr_t async_instance_finalize(void) {
...
static herr_t async_term(void) {
  ...
  if (ABT_SUCCESS != abt_ret) {
    ...
    goto done;
           ...
           (async_instance_g->mpi_rank == ASYNC_DBG_MSG_RANK ||
            -1 == ASYNC_DBG_MSG_RANK))
...
static herr_t async_instance_init(int backing_thread_count) {
  herr_t hg_ret = 0;
  ...
  if (backing_thread_count == 0) {
    ...
    progress_xstreams =
        (ABT_xstream *)calloc(backing_thread_count, sizeof(ABT_xstream));
    ...
    progress_scheds =
        (ABT_sched *)calloc(backing_thread_count, sizeof(ABT_sched));
    ...
    abt_ret = ABT_pool_create_basic(ABT_POOL_FIFO_WAIT, ABT_POOL_ACCESS_MPMC,
                                    ABT_TRUE, &pool);
    if (abt_ret != ABT_SUCCESS) {
      free(progress_xstreams);
...
herr_t H5VL_async_set_disable_implicit(hbool_t is_disable) {
...
herr_t H5VL_async_fapl_set_disable_implicit(hid_t fapl) {
  herr_t status = 0;
    ...
    if (status < 0) {
      ...
      if (async_instance_g->disable_implicit_file) {
        ...
        if (async_instance_g &&
          ...
          fprintf(
              fout_g,
              "  [ASYNC VOL DBG] set implicit mode to false (new fapl used)\n");
#endif
      }
    }
  }
...
herr_t H5VL_async_dxpl_set_disable_implicit(hid_t dxpl) {
  herr_t status = 0;
  hbool_t is_disable = false;
      ...
      if (async_instance_g->disable_implicit_file) {
        ...
        if (async_instance_g &&
            (async_instance_g->mpi_rank == ASYNC_DBG_MSG_RANK ||
             -1 == ASYNC_DBG_MSG_RANK))
          fprintf(fout_g,
                  "  [ASYNC VOL DBG] already set disable implicit file\n");
#endif
      } else {
...
herr_t H5VL_async_dxpl_set_pause(hid_t dxpl) {
  herr_t status = 0;
    ...
    if (status < 0) {
      ...
      if (async_instance_g->pause != is_pause) {
        ...
        if (async_instance_g &&
            (async_instance_g->mpi_rank == ASYNC_DBG_MSG_RANK ||
             -1 == ASYNC_DBG_MSG_RANK))
          fprintf(fout_g, "  [ASYNC VOL DBG] set pause async execution to "
                          "false (new dxpl used)\n");
#endif
      }
    }
    ...
    if (status < 0) {
      ...
      if (async_instance_g->delay_time != delay_us) {
        ...
        if (async_instance_g &&
          ...
          fprintf(
              fout_g,
              "  [ASYNC VOL DBG] set async delay time to 0 (new dxpl used)\n");
#endif
      }
    }
  } // End if dxpl
...
static herr_t H5VL_async_init(hid_t __attribute__((unused)) vipl_id) {
  ...
  if (NULL == async_instance_g) {
    ...
    if (H5VLregister_opt_operation(H5VL_SUBCLS_FILE, H5VL_ASYNC_DYN_FILE_WAIT,
      ...
      fprintf(fout_g, "  [ASYNC VOL ERROR] with H5VLregister_opt_operation "
                      "H5VL_async_file_wait_op_g\n");
      return (-1);
    }
    assert(-1 != H5VL_async_file_wait_op_g);
    ...
    if (H5VLregister_opt_operation(H5VL_SUBCLS_DATASET,
                                   H5VL_ASYNC_DYN_DATASET_WAIT,
                                   &H5VL_async_dataset_wait_op_g) < 0) {
      fprintf(fout_g, "  [ASYNC VOL ERROR] with H5VLregister_opt_operation "
                      "H5VL_async_dataset_wait_op_g\n");
      return (-1);
    }
    assert(-1 != H5VL_async_dataset_wait_op_g);
    ...
    if (H5VLregister_opt_operation(H5VL_SUBCLS_DATASET,
                                   H5VL_ASYNC_DYN_DATASET_START,
                                   &H5VL_async_dataset_start_op_g) < 0) {
      fprintf(fout_g, "  [ASYNC VOL ERROR] with H5VLregister_opt_operation "
                      "H5VL_async_dataset_start_op_g\n");
      return (-1);
    }
    assert(-1 != H5VL_async_dataset_start_op_g);
    ...
    if (H5VLregister_opt_operation(H5VL_SUBCLS_DATASET,
                                   H5VL_ASYNC_DYN_DATASET_PAUSE,
                                   &H5VL_async_dataset_pause_op_g) < 0) {
      fprintf(fout_g, "  [ASYNC VOL ERROR] with H5VLregister_opt_operation "
                      "H5VL_async_dataset_pause_op_g\n");
      return (-1);
    }
    assert(-1 != H5VL_async_dataset_pause_op_g);
    ...
    if (H5VLregister_opt_operation(H5VL_SUBCLS_DATASET,
      ...
      fprintf(fout_g, "  [ASYNC VOL ERROR] with H5VLregister_opt_operation "
                      "H5VL_async_dataset_delay_op_g\n");
      return (-1);
    }
    assert(-1 != H5VL_async_dataset_delay_op_g);

    assert(-1 == H5VL_async_request_start_op_g);
    if (H5VLregister_opt_operation(H5VL_SUBCLS_REQUEST,
                                   H5VL_ASYNC_DYN_REQUEST_START,
                                   &H5VL_async_request_start_op_g) < 0) {
      fprintf(fout_g, "  [ASYNC VOL ERROR] with H5VLregister_opt_operation "
                      "H5VL_async_request_start_op_g\n");
      return (-1);
    }
    assert(-1 != H5VL_async_request_start_op_g);
    ...
    if (H5VLregister_opt_operation(H5VL_SUBCLS_REQUEST,
      ...
      fprintf(fout_g, "  [ASYNC VOL ERROR] with H5VLregister_opt_operation "
                      "H5VL_async_request_depend_op_g\n");
      return (-1);
    }
    assert(-1 != H5VL_async_request_depend_op_g);
  }
  ...
  if (H5I_INVALID_HID == async_error_class_g) {
    if ((async_error_class_g =
             H5Eregister_class("Async VOL", "Async VOL", "0.1")) < 0) {
...
static void async_waitall(void) {
...
static herr_t H5VL_async_term(void) {
  ...
  if (H5I_INVALID_HID != async_error_class_g) {
    if (H5Eunregister_class(async_error_class_g) < 0)
      fprintf(fout_g,
              "  [ASYNC VOL ERROR] ASYNC VOL unregister error class failed\n");
...
static async_task_t *create_async_task(void) {
...
/*     if (ABT_mutex_lock(async_obj->file_async_obj->file_task_list_mutex) !=
 * ABT_SUCCESS) { */
...
/*     DL_FOREACH_SAFE2(async_obj->file_task_list_head, task_iter, tmp,
 * file_list_next) { */
...
/*     if (ABT_mutex_unlock(async_obj->file_async_obj->file_task_list_mutex) !=
 * ABT_SUCCESS) { */
...
static void free_file_async_resources(H5VL_async_t *file) {
  ...
  if (file->file_task_list_mutex &&
      ABT_mutex_lock(file->file_task_list_mutex) != ABT_SUCCESS) {
    fprintf(fout_g, "  [ASYNC VOL ERROR] %s with ABT_mutex_lock\n", __func__);
    return;
  }

  DL_FOREACH_SAFE2(file->file_async_obj->file_task_list_head, task_iter, tmp,
                   file_list_next) {
    DL_DELETE2(file->file_async_obj->file_task_list_head, task_iter,
               file_list_prev, file_list_next);
    // Defer the file close task free operation to later request free so
    // H5ESwait works even after file is closed
    if (task_iter->func != async_file_close_fn &&
        task_iter->magic == TASK_MAGIC) {
      free_async_task(task_iter);
    }
  }

  if (file->file_task_list_mutex &&
      ABT_mutex_unlock(file->file_task_list_mutex) != ABT_SUCCESS) {
    fprintf(fout_g, "  [ASYNC VOL ERROR] %s with ABT_mutex_unlock\n", __func__);
    return;
  }
  ...
  if (file->file_task_list_mutex &&
      ABT_mutex_free(&file->file_task_list_mutex) != ABT_SUCCESS) {
    fprintf(fout_g, "  [ASYNC VOL ERROR] %s with ABT_mutex_free\n", __func__);
    return;
  }

  // File object is freed later at request free time for event set to working
  // after file close
  /* free(file); */
}

static herr_t add_to_dep_task(async_task_t *task, async_task_t *parent_task) {
  assert(task);
  assert(parent_task);
  ...
  if (task->n_dep_alloc == 0 || task->dep_tasks == NULL) {
    // Initial alloc
    task->dep_tasks =
        (async_task_t **)calloc(ALLOC_INITIAL_SIZE, sizeof(async_task_t *));
...
static int get_n_running_task_in_queue(async_task_t *task) {
  int remaining_task = 0;
  ABT_thread_state thread_state;
  async_task_t *task_elt;

  /* if (ABT_mutex_lock(task->async_obj->file_async_obj->file_task_list_mutex)
   * != ABT_SUCCESS) { */
  /*     fprintf(fout_g,"  [ASYNC VOL ERROR] %s with ABT_mutex_lock\n",
   * __func__); */
  /*     return -1; */
...
int get_n_running_task_in_queue_obj(H5VL_async_t *async_obj) {
  ...
  DL_FOREACH2(async_obj->file_task_list_head, task_elt, file_list_next) {
    if (task_elt->magic == TASK_MAGIC && task_elt->abt_thread != NULL) {
      ABT_thread_get_state(task_elt->abt_thread, &thread_state);
      if (thread_state == ABT_THREAD_STATE_RUNNING ||
          thread_state == ABT_THREAD_STATE_READY)
        remaining_task++;
    }
  }
...
static herr_t push_task_to_abt_pool(async_qhead_t *qhead, ABT_pool pool) {
  ...
  DL_FOREACH_SAFE(qhead->queue, task_list_elt, task_list_tmp) {
    DL_FOREACH_SAFE(task_list_elt->task_list, task_elt, task_tmp) {
      ...
      for (i = 0; i < task_elt->n_dep; i++) {
        ...
        /*     H5Eappend_stack(task_elt->err_stack,
         * task_elt->dep_tasks[i]->err_stack, false); */
        /*     H5Epush(task_elt->err_stack, __FILE__, __func__, __LINE__,
         * async_error_class_g, */
        ...
        if (task_elt->dep_tasks[i]->is_done != 1) {
          ...
          if (async_instance_g &&
              (async_instance_g->mpi_rank == ASYNC_DBG_MSG_RANK ||
               -1 == ASYNC_DBG_MSG_RANK))
            fprintf(fout_g,
                    "  [ASYNC VOL DBG] dependent task [%p] not finished\n",
        ...
        if (NULL != task_elt->dep_tasks[i]->abt_thread) {
          ...
          /*     continue; */
          /* } */
          if (ABT_thread_get_state(task_elt->dep_tasks[i]->abt_thread,
                                   &thread_state) != ABT_SUCCESS) {
            fprintf(fout_g,
                    "  [ASYNC VOL ERROR] %s with ABT_thread_get_state\n",
                    __func__);
            return -1;
          }
          if (thread_state != ABT_THREAD_STATE_TERMINATED &&
            ...
            if (async_instance_g &&
                (async_instance_g->mpi_rank == ASYNC_DBG_MSG_RANK ||
                 -1 == ASYNC_DBG_MSG_RANK))
              fprintf(fout_g,
                      "  [ASYNC VOL DBG] dependent task [%p] not finished in "
                      "ABT pool\n",
                      task_elt->dep_tasks[i]->func);
#endif
            break;
      ...
      if (task_elt->is_done == 0) {
        ...
        if (async_instance_g &&
            (async_instance_g->mpi_rank == ASYNC_DBG_MSG_RANK ||
             -1 == ASYNC_DBG_MSG_RANK))
          fprintf(fout_g,
                  "  [ASYNC VOL DBG] %d tasks already in Argobots pool\n",
                  ntask);
#endif
        if (ntask > 1) {
#ifdef ENABLE_DBG_MSG
          fprintf(
              fout_g,
              "  [ASYNC VOL DBG] Rank %d: %d tasks already in Argobots pool\n",
        ...
        if (ABT_thread_create(pool, task_elt->func, task_elt,
                              ABT_THREAD_ATTR_NULL,
                              &task_elt->abt_thread) != ABT_SUCCESS) {
          fprintf(fout_g,
                  "  [ASYNC VOL ERROR] %s ABT_thread_create failed for %p\n",
  ...
  /* // If the dependent parents of tasks in the dependent task list failed,
   * resulting in no executing, */
...
/*
 * Any read/write operation must be executed after a prior write operation of
 * same object. Any write operation must be executed after a prior read
 * operation of same object. Any collective operation must be executed in same
 * order with regards to other collective operations. There can only be 1
 * collective operation in execution at any time (amongst all the threads on a
 * process).
 */
static herr_t add_task_to_queue(async_qhead_t *qhead, async_task_t *task,
   ...
   *       If collective, create a new CTL, or append it to an existing tail
   * CTL.
   * 2. Check for object dependency.
   *       E.g. a group open depends on its file open/create.
   *       (Rule 1) Any read/write operation depends on a prior write operation
   * of same object. (Rule 2) Any write operation depends on a prior read
   * operation of same object. If satisfies any of the above, create a new DTL
   * and insert to it.
   * 3. If the async task is not the above 2, create or insert it to tail RTL.
   *       If current RTL is also head, add to Argobots pool.
   * 4. Any time an async task has completed, push all tasks in the head into
   * Argobots pool.
   */
  ...
  if (task_type == DEPENDENT) {
    ...
    if (task != task->async_obj->create_task &&
    ...
    /* Any read/write operation must be executed after a prior write operation
     * of same object. */
    /* Any write operation must be executed after a prior read operation of same
     * object. */
    is_end = 0;
    DL_FOREACH2(tail_list, task_list_elt, prev) {
      tail_task = task_list_elt->task_list == NULL
                      ? NULL
                      : task_list_elt->task_list->prev;
      is_end2 = 0;
    ...
    DL_FOREACH2(task->async_obj->file_task_list_head, task_elt,
                file_list_next) {
    ...
    if (ABT_mutex_unlock(
            task->async_obj->file_async_obj->file_task_list_mutex) !=
        ABT_SUCCESS) {
      fprintf(fout_g, "  [ASYNC VOL ERROR] %s with ABT_mutex_unlock\n",
              __func__);
      return -1;
  ...
  /*         fprintf(fout_g,"  [ASYNC VOL ERROR] %s ABT_thread_create failed for
   * %p\n", __func__, task->func); */
  /*         return -1; */
  /*     } */
  /*     return 1; */
  ...
  if (qhead->queue && qhead->queue->prev->type == task_type &&
    ...
    async_task_list_t *new_list =
        (async_task_list_t *)calloc(1, sizeof(async_task_list_t));
    new_list->type = task_type;
#ifdef ENABLE_DBG_MSG
    if (async_instance_g && (async_instance_g->mpi_rank == ASYNC_DBG_MSG_RANK ||
                             -1 == ASYNC_DBG_MSG_RANK))
      fprintf(fout_g,
              "  [ASYNC VOL DBG] create and append [%p] to new %s task list\n",
              task->func, qtype_names_g[task_type]);
#endif
...
static void execute_parent_task_recursive(async_task_t *task) {
  ...
  if (task->in_abt_pool == 1) {
    ...
    if (async_instance_g && (async_instance_g->mpi_rank == ASYNC_DBG_MSG_RANK ||
                             -1 == ASYNC_DBG_MSG_RANK))
      fprintf(fout_g,
              "  [ASYNC VOL DBG] %s: cancel argobots task and execute now \n",
              __func__);
#endif
...
static herr_t async_realize_future_cb(void *_future_object,
...
static herr_t async_discard_future_cb(void *future_object) {
...
static void dup_loc_param(H5VL_loc_params_t *dest,
                          H5VL_loc_params_t const *loc_params) {
  size_t ref_size;
  ...
  if (loc_params->type == H5VL_OBJECT_BY_NAME) {
    if (NULL != loc_params->loc_data.loc_by_name.name)
      dest->loc_data.loc_by_name.name =
          strdup(loc_params->loc_data.loc_by_name.name);
    dest->loc_data.loc_by_name.lapl_id =
        H5Pcopy(loc_params->loc_data.loc_by_name.lapl_id);
  } else if (loc_params->type == H5VL_OBJECT_BY_IDX) {
    if (NULL != loc_params->loc_data.loc_by_idx.name)
      dest->loc_data.loc_by_idx.name =
          strdup(loc_params->loc_data.loc_by_idx.name);
    dest->loc_data.loc_by_idx.lapl_id =
        H5Pcopy(loc_params->loc_data.loc_by_idx.lapl_id);
...
static int dup_attr_get_args(H5VL_attr_get_args_t *dst_args,
                             H5VL_attr_get_args_t *src_args,
                             async_task_t *task) {
  ...
  case H5VL_ATTR_GET_INFO:
    dup_loc_param(&dst_args->args.get_info.loc_params,
                  &src_args->args.get_info.loc_params);
    if (src_args->args.get_info.attr_name)
      dst_args->args.get_info.attr_name =
          strdup(src_args->args.get_info.attr_name);
    break;

  case H5VL_ATTR_GET_NAME:
    dup_loc_param(&dst_args->args.get_name.loc_params,
                  &src_args->args.get_name.loc_params);
    break;
  ...
  if (need_future_id) {
    ...
    *future_id_ptr =
        H5Iregister_future(future_id_type, future_obj, async_realize_future_cb,
                           async_discard_future_cb);
    if (*future_id_ptr < 0) {
...
static void free_attr_get_args(H5VL_attr_get_args_t *args, async_task_t *task) {
  assert(args);
  assert(task);
...
static void dup_attr_spec_args(H5VL_attr_specific_args_t *dst_args,
                               const H5VL_attr_specific_args_t *src_args) {
  assert(dst_args);
  assert(src_args);
...
static void free_attr_spec_args(H5VL_attr_specific_args_t *args) {
  assert(args);
...
static void
dup_native_attr_optional_args(async_attr_optional_args_t *dst_args,
...
static void free_native_attr_optional_args(async_attr_optional_args_t *args) {
  assert(args);
...
static int dup_dataset_get_args(H5VL_dataset_get_args_t *dst_args,
                                H5VL_dataset_get_args_t *src_args,
                                async_task_t *task) {
  hid_t *future_id_ptr = NULL;           /* Pointer to ID for future ID */
  H5I_type_t future_id_type = H5I_BADID; /* Type ("class") of future ID */
  hbool_t need_future_id = false; /* Whether an operation needs a future ID */
...
static void free_dataset_get_args(H5VL_dataset_get_args_t *args,
                                  async_task_t *task) {
  assert(args);
  assert(task);
...
static void
dup_dataset_spec_args(H5VL_dataset_specific_args_t *dst_args,
                      const H5VL_dataset_specific_args_t *src_args) {
  assert(dst_args);
  assert(src_args);
...
static void free_dataset_spec_args(H5VL_dataset_specific_args_t *args) {
  assert(args);
...
dup_native_dataset_optional_args(async_dataset_optional_args_t *dst_args,
  ...
  if (src_args->op_type < H5VL_RESERVED_NATIVE_OPTIONAL) {
    ...
    case H5VL_NATIVE_DATASET_GET_VLEN_BUF_SIZE:
      dst_args->opt_args.get_vlen_buf_size.type_id =
          H5Tcopy(((H5VL_native_dataset_optional_args_t *)src_args->args)
                      ->get_vlen_buf_size.type_id);
      dst_args->opt_args.get_vlen_buf_size.space_id =
          H5Scopy(((H5VL_native_dataset_optional_args_t *)src_args->args)
                      ->get_vlen_buf_size.space_id);
      break;

    case H5VL_NATIVE_DATASET_GET_NUM_CHUNKS:
      dst_args->opt_args.get_num_chunks.space_id =
          H5Scopy(((H5VL_native_dataset_optional_args_t *)src_args->args)
                      ->get_num_chunks.space_id);
      break;

    case H5VL_NATIVE_DATASET_GET_CHUNK_INFO_BY_IDX:
      dst_args->opt_args.get_chunk_info_by_idx.space_id =
          H5Scopy(((H5VL_native_dataset_optional_args_t *)src_args->args)
                      ->get_chunk_info_by_idx.space_id);
      break;
...
static int dup_datatype_get_args(H5VL_datatype_get_args_t *dst_args,
                                 H5VL_datatype_get_args_t *src_args,
                                 async_task_t *task) {
  hid_t *future_id_ptr = NULL;           /* Pointer to ID for future ID */
  H5I_type_t future_id_type = H5I_BADID; /* Type ("class") of future ID */
  hbool_t need_future_id = false; /* Whether an operation needs a future ID */
...
static void free_datatype_get_args(H5VL_datatype_get_args_t *args,
                                   async_task_t *task) {
  assert(args);
  assert(task);
...
static void
dup_datatype_spec_args(H5VL_datatype_specific_args_t *dst_args,
                       const H5VL_datatype_specific_args_t *src_args) {
  assert(dst_args);
  assert(src_args);
...
static void free_datatype_spec_args(H5VL_datatype_specific_args_t *args) {
  assert(args);
...
static int dup_file_get_args(H5VL_file_get_args_t *dst_args,
                             H5VL_file_get_args_t *src_args,
                             async_task_t *task) {
  hid_t *future_id_ptr = NULL;           /* Pointer to ID for future ID */
  H5I_type_t future_id_type = H5I_BADID; /* Type ("class") of future ID */
  hbool_t need_future_id = false; /* Whether an operation needs a future ID */
...
static void free_file_get_args(H5VL_file_get_args_t *args, async_task_t *task) {
  assert(args);
...
static void dup_file_spec_args(H5VL_file_specific_args_t *dst_args,
                               const H5VL_file_specific_args_t *src_args) {
  assert(dst_args);
  assert(src_args);
  ...
  case H5VL_FILE_IS_ACCESSIBLE:
    if (src_args->args.is_accessible.filename)
      dst_args->args.is_accessible.filename =
          strdup(src_args->args.is_accessible.filename);
    if (src_args->args.is_accessible.fapl_id)
      dst_args->args.is_accessible.fapl_id =
          H5Pcopy(src_args->args.is_accessible.fapl_id);
    break;
...
static void free_file_spec_args(H5VL_file_specific_args_t *args) {
  assert(args);
...
static void
dup_native_file_optional_args(async_file_optional_args_t *dst_args,
                              const H5VL_optional_args_t *src_args) {
  assert(dst_args);
  assert(src_args);
  ...
  if (src_args->op_type < H5VL_RESERVED_NATIVE_OPTIONAL) {
    ...
    case H5VL_NATIVE_FILE_GET_VFD_HANDLE:
      dst_args->opt_args.get_vfd_handle.fapl_id =
          H5Pcopy(((H5VL_native_file_optional_args_t *)src_args->args)
                      ->get_vfd_handle.fapl_id);
      break;
...
static void free_native_file_optional_args(async_file_optional_args_t *args) {
  assert(args);
...
static int dup_group_get_args(H5VL_group_get_args_t *dst_args,
                              H5VL_group_get_args_t *src_args,
                              async_task_t *task) {
  hid_t *future_id_ptr = NULL;           /* Pointer to ID for future ID */
  H5I_type_t future_id_type = H5I_BADID; /* Type ("class") of future ID */
  hbool_t need_future_id = false; /* Whether an operation needs a future ID */
...
static void free_group_get_args(H5VL_group_get_args_t *args,
                                async_task_t *task) {
  assert(args);
...
static void dup_group_spec_args(H5VL_group_specific_args_t *dst_args,
                                const H5VL_group_specific_args_t *src_args) {
  assert(dst_args);
  assert(src_args);
...
static void free_group_spec_args(H5VL_group_specific_args_t *args) {
  assert(args);
...
static void
dup_native_group_optional_args(async_group_optional_args_t *dst_args,
                               const H5VL_optional_args_t *src_args) {
  assert(dst_args);
  assert(src_args);
  ...
  if (src_args->op_type < H5VL_RESERVED_NATIVE_OPTIONAL) {
    ...
    case H5VL_NATIVE_GROUP_ITERATE_OLD:
      dup_loc_param(&dst_args->opt_args.iterate_old.loc_params,
                    &((H5VL_native_group_optional_args_t *)src_args->args)
                         ->iterate_old.loc_params);
      break;

    case H5VL_NATIVE_GROUP_GET_OBJINFO:
      dup_loc_param(&dst_args->opt_args.get_objinfo.loc_params,
                    &((H5VL_native_group_optional_args_t *)src_args->args)
                         ->get_objinfo.loc_params);
      break;
...
static void free_native_group_optional_args(async_group_optional_args_t *args) {
  assert(args);
...
static void dup_link_create_args(H5VL_link_create_args_t *dst_args,
                                 const H5VL_link_create_args_t *src_args) {
  assert(dst_args);
  assert(src_args);
  ...
  case H5VL_LINK_CREATE_HARD:
    dst_args->args.hard.curr_obj =
        ((H5VL_async_t *)src_args->args.hard.curr_obj)->under_object;
    dup_loc_param(&dst_args->args.hard.curr_loc_params,
                  &src_args->args.hard.curr_loc_params);
    break;
  ...
  case H5VL_LINK_CREATE_UD:
    ...
    memcpy((void *)dst_args->args.ud.buf, src_args->args.ud.buf,
           src_args->args.ud.buf_size);
    break;
...
static void free_link_create_args(H5VL_link_create_args_t *args) {
  assert(args);
...
static void dup_link_get_args(H5VL_link_get_args_t *dst_args,
                              const H5VL_link_get_args_t *src_args) {
  assert(dst_args);
  assert(src_args);
...
static void free_link_get_args(H5VL_link_get_args_t *args) {
  assert(args);
...
static void dup_link_spec_args(H5VL_link_specific_args_t *dst_args,
                               const H5VL_link_specific_args_t *src_args) {
  assert(dst_args);
  assert(src_args);
...
static void free_link_spec_args(H5VL_link_specific_args_t *args) {
  assert(args);
...
static void
dup_native_link_optional_args(async_link_optional_args_t *dst_args,
                              const H5VL_optional_args_t *src_args) {
  assert(dst_args);
  assert(src_args);
...
static void free_native_link_optional_args(async_link_optional_args_t *args) {
  assert(args);
...
static void dup_object_get_args(H5VL_object_get_args_t *dst_args,
                                const H5VL_object_get_args_t *src_args) {
  assert(dst_args);
  assert(src_args);
...
static void free_object_get_args(H5VL_object_get_args_t *args) {
  assert(args);
...
static void dup_object_spec_args(H5VL_object_specific_args_t *dst_args,
                                 const H5VL_object_specific_args_t *src_args) {
  assert(dst_args);
  assert(src_args);
...
static void free_object_spec_args(H5VL_object_specific_args_t *args) {
  assert(args);
...
static void
dup_native_object_optional_args(async_object_optional_args_t *dst_args,
                                const H5VL_optional_args_t *src_args) {
  assert(dst_args);
  assert(src_args);
  ...
  if (src_args->op_type < H5VL_RESERVED_NATIVE_OPTIONAL) {
    ...
    case H5VL_NATIVE_OBJECT_SET_COMMENT:
      if (((H5VL_native_object_optional_args_t *)src_args->args)
              ->set_comment.comment)
        dst_args->opt_args.set_comment.comment =
            strdup(((H5VL_native_object_optional_args_t *)src_args->args)
                       ->set_comment.comment);
      break;
 ...
 */
/*     if (ret != 0) { */
/*         fprintf(fout_g, "  [ASYNC VOL ERROR] with pthread_setaffinity_np:
 * %d\n", ret); */
/*         return; */
/*     } */
/* } */
...
/*     /1* ret = pthread_getaffinity_np(pthread_self(), sizeof(cpu_set_t),
 * &cpuset); *1/ */
/*     /1* if (ret != 0) { *1/ */
/*     /1*     fprintf(fout_g, "  [ASYNC VOL ERROR] with pthread_getaffinity_np:
 * %d\n", ret); *1/ */
/*     /1*     return; *1/ */
/*     /1* } *1/ */
/*     /1* fprintf(fout_g, "Set returned by pthread_getaffinity_np()
 * contained:\n"); *1/ */
...
/*     /1*     fprintf(fout_g, "  [ASYNC VOL ERROR] with
...
/*     if (ret != ABT_SUCCESS) { */
/*         fprintf(fout_g, "  [ASYNC VOL ERROR] with
...
/*         num_cpus = 0; */
/*         ret = ABT_xstream_get_affinity(xstream, cpuset_size, cpuset,
 * &num_cpus); */
/*         if (ret != ABT_SUCCESS) { */
/*             fprintf(fout_g, "  [ASYNC VOL ERROR] with
 * ABT_xstream_get_affinity\n"); */
...
/*     /1*     return; *1/ */
/*     /1* } *1/ */
/*     /1* ret = ABT_xstream_get_affinity(xstream, num_xstreams, cpuset,
 * &num_cpus); *1/ */
/*     /1* if (ret != ABT_SUCCESS) { *1/ */
/*     /1*     fprintf(fout_g, "  [ASYNC VOL ERROR] with
 * ABT_xstream_get_affinity\n"); *1/ */
...
static int check_app_acquire_mutex(async_task_t *task,
  ...
  while (async_instance_g->pause) {
    ...
    if (wait_count == 10000) {
      fprintf(
          fout_g,
          "  [ASYNC ABT INFO] async operations are paused for 10 seconds, use "
  ...
  if (H5TSmutex_get_attempt_count(&attempt_count) < 0) {
    fprintf(fout_g,
            "  [ASYNC ABT ERROR] %s H5TSmutex_get_attempt_count failed\n",
            __func__);
    return -1;
  }

  if (!async_instance_g->start_abt_push &&
      async_instance_g->ex_delay == false) {
    while (1) {
      if (task->async_obj->file_async_obj->attempt_check_cnt %
              ASYNC_ATTEMPT_CHECK_INTERVAL ==
          0) {
        ...
        if (new_attempt_count <= attempt_count) {
          ...
          if (async_instance_g &&
            ...
            fprintf(
                fout_g,
                "  [ASYNC ABT DBG] %s counter %d/%d, reset wait time to %d \n",
                __func__, attempt_count, new_attempt_count,
                async_instance_g->sleep_time);
#endif
          break;
        }
  ...
  while (*acquired == false) {
    ...
    if (wait_count > 0) {
      ...
      if (wait_count == 10000) {
        fprintf(fout_g,
                "  [ASYNC ABT INFO] %s unable to acquire HDF5 mutex for 10 "
                "seconds, deadlock?\n",
                __func__);
        wait_count = 0;
      }
  ...
  return (new_attempt_count > attempt_count ? new_attempt_count
                                            : attempt_count);
}

static void check_app_wait(int attempt_count, const char *func_name) {
  ...
  // If the application thread is waiting, double the current sleep time for
  // next status check
  if (attempt_count > 0 && new_attempt_count > attempt_count + op_count) {
    if (async_instance_g->sleep_time < ASYNC_APP_CHECK_SLEEP_TIME_MAX) {
      ...
      if (async_instance_g &&
        ...
        fprintf(
            fout_g,
            "  [ASYNC ABT DBG] %s counter %d/%d, increase wait time to %d \n",
            func_name, attempt_count, new_attempt_count,
            async_instance_g->sleep_time);
#endif
    }
...
static int check_parent_task(H5VL_async_t *parent_obj) {
  int ret_val = 0;
...
static void async_attr_create_fn(void *foo) {
  ...
  if (NULL == args->obj) {
    if (NULL != task->parent_obj->under_object) {
      ...
      if (check_parent_task(task->parent_obj) != 0) {
        ...
        H5Eappend_stack(task->err_stack,
                        task->parent_obj->create_task->err_stack, false);
        H5Epush(task->err_stack, __FILE__, __func__, __LINE__,
                async_error_class_g, H5E_VOL, H5E_CANTCREATE,
                "Parent task failed");
      ...
      if (async_instance_g &&
        ...
        fprintf(
            fout_g,
            "  [ASYNC ABT ERROR] %s parent object is NULL, re-insert to pool\n",
            __func__);
#endif
      if (ABT_thread_create(*task->async_obj->pool_ptr, task->func, task,
                            ABT_THREAD_ATTR_NULL,
        ...
        fprintf(fout_g,
                "  [ASYNC ABT ERROR] %s ABT_thread_create failed for %p\n",
                __func__, task->func);
      }
  ...
  if (async_instance_g && (async_instance_g->mpi_rank == ASYNC_DBG_MSG_RANK ||
    ...
    fprintf(fout_g, "  [ASYNC ABT DBG] %s: trying to aquire global lock\n",
            __func__);
#endif
  if ((attempt_count = check_app_acquire_mutex(task, &mutex_count, &acquired)) <
      0)
    goto done;
#ifdef ENABLE_DBG_MSG
  if (async_instance_g && (async_instance_g->mpi_rank == ASYNC_DBG_MSG_RANK ||
  ...
  H5E_BEGIN_TRY {
    obj = H5VLattr_create(args->obj, args->loc_params, task->under_vol_id,
                          args->name, args->type_id, args->space_id,
                          args->acpl_id, args->aapl_id, args->dxpl_id, NULL);
...
static H5VL_async_t *
async_attr_create(async_instance_t *aid, H5VL_async_t *parent_obj,
  ...
  if ((args = (async_attr_create_args_t *)calloc(
           1, sizeof(async_attr_create_args_t))) == NULL) {
    fprintf(fout_g, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
    goto error;
  }

  /* create a new async object */
  if ((async_obj = H5VL_async_new_obj(NULL, parent_obj->under_vol_id)) ==
      NULL) {
    fprintf(fout_g, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
    goto error;
  }
  ...
  if (loc_params->type == H5VL_OBJECT_BY_IDX &&
      loc_params->loc_data.loc_by_idx.lapl_id < 0) {
  ...
  if (req) {
    ...
    if ((new_req = H5VL_async_new_obj(NULL, parent_obj->under_vol_id)) ==
        NULL) {
  ...
  while (1) {
    if (parent_obj->obj_mutex &&
        ABT_mutex_trylock(parent_obj->obj_mutex) == ABT_SUCCESS) {
      lock_parent = true;
      break;
    }
    usleep(1000);
  ...
  if (ABT_mutex_lock(parent_obj->file_async_obj->file_task_list_mutex) !=
      ABT_SUCCESS) {
    fprintf(fout_g, "  [ASYNC VOL ERROR] %s with ABT_mutex_lock\n", __func__);
    goto done;
  }
  /* Insert it into the file task list */
  DL_APPEND2(parent_obj->file_task_list_head, async_task, file_list_prev,
             file_list_next);
  if (ABT_mutex_unlock(parent_obj->file_async_obj->file_task_list_mutex) !=
      ABT_SUCCESS) {
    fprintf(fout_g, "  [ASYNC VOL ERROR] %s with ABT_mutex_unlock\n", __func__);
    goto done;
  }
  ...
  if (is_blocking) {
    if (async_instance_g->start_abt_push ||
        get_n_running_task_in_queue(async_task) == 0)
      push_task_to_abt_pool(&aid->qhead, aid->pool);
    ...
    if (async_instance_g && (async_instance_g->mpi_rank == ASYNC_DBG_MSG_RANK ||
                             -1 == ASYNC_DBG_MSG_RANK))
      fprintf(fout_g,
              "  [ASYNC VOL DBG] %s waiting to finish all previous tasks\n",
              __func__);
#endif
    ...
    if (async_instance_g && (async_instance_g->mpi_rank == ASYNC_DBG_MSG_RANK ||
                             -1 == ASYNC_DBG_MSG_RANK))
      fprintf(fout_g,
              "  [ASYNC VOL DBG] %s finished all previous tasks, proceed\n",
              __func__);
#endif
    while (acquired == false) {
      if (H5TSmutex_acquire(mutex_count, &acquired) < 0) {
...
static void async_attr_open_fn(void *foo) {
  ...
  /* Try executing operation, without default error stack handling */
  H5E_BEGIN_TRY {
    obj = H5VLattr_open(args->obj, args->loc_params, task->under_vol_id,
                        args->name, args->aapl_id, args->dxpl_id, NULL);
    check_app_wait(attempt_count, __func__);
  }
  H5E_END_TRY
  if (NULL == obj) {
...
static H5VL_async_t *async_attr_open(async_instance_t *aid,
  ...
  if ((args = (async_attr_open_args_t *)calloc(
           1, sizeof(async_attr_open_args_t))) == NULL) {
    fprintf(fout_g, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
    goto error;
  }
  /* create a new async object */
...
static void async_attr_read_fn(void *foo) {
  ...
  /* Try executing operation, without default error stack handling */
  H5E_BEGIN_TRY {
    status = H5VLattr_read(args->attr, task->under_vol_id, args->mem_type_id,
                           args->buf, args->dxpl_id, NULL);
    check_app_wait(attempt_count, __func__);
  }
  H5E_END_TRY
  if (status < 0) {
...
static herr_t async_attr_read(async_instance_t *aid, H5VL_async_t *parent_obj,
                              hid_t mem_type_id, void *buf, hid_t dxpl_id,
                              void **req) {
  ...
  if ((args = (async_attr_read_args_t *)calloc(
           1, sizeof(async_attr_read_args_t))) == NULL) {
    fprintf(fout_g, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
    goto error;
  }
  /* create a new task and insert into its file task list */
...
static void async_attr_write_fn(void *foo) {
  ...
  /* Try executing operation, without default error stack handling */
  H5E_BEGIN_TRY {
    status = H5VLattr_write(args->attr, task->under_vol_id, args->mem_type_id,
                            args->buf, args->dxpl_id, NULL);
    check_app_wait(attempt_count, __func__);
  }
  H5E_END_TRY
...
static herr_t async_attr_write(async_instance_t *aid, H5VL_async_t *parent_obj,
  ...
  if ((args = (async_attr_write_args_t *)calloc(
           1, sizeof(async_attr_write_args_t))) == NULL) {
    fprintf(fout_g, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
    goto error;
  }
  /* create a new task and insert into its file task list */
...
static void async_attr_get_fn(void *foo) {
  ...
  /* Try executing operation, without default error stack handling */
  H5E_BEGIN_TRY {
    status = H5VLattr_get(args->obj, task->under_vol_id, &args->args,
                          args->dxpl_id, NULL);
    check_app_wait(attempt_count, __func__);
  }
  H5E_END_TRY
...
static herr_t async_attr_get(task_list_qtype qtype, async_instance_t *aid,
                             H5VL_async_t *parent_obj,
                             H5VL_attr_get_args_t *get_args, hid_t dxpl_id,
                             void **req) {
  async_task_t *async_task = NULL;
  ...
  if ((args = (async_attr_get_args_t *)calloc(
           1, sizeof(async_attr_get_args_t))) == NULL) {
    fprintf(fout_g, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
    goto error;
  }
  /* create a new task and insert into its file task list */
  ...
  if (dup_attr_get_args(&args->args, get_args, async_task) < 0) {
    fprintf(fout_g,
            "  [ASYNC VOL ERROR] %s with duplicating attribute get arguments\n",
            __func__);
    goto error;
  }
  if (dxpl_id > 0)
...
static void async_attr_specific_fn(void *foo) {
  ...
  /* Try executing operation, without default error stack handling */
  H5E_BEGIN_TRY {
    status = H5VLattr_specific(args->obj, args->loc_params, task->under_vol_id,
                               &args->args, args->dxpl_id, NULL);
    check_app_wait(attempt_count, __func__);
  }
  H5E_END_TRY
  if (status < 0) {
...
static herr_t async_attr_specific(task_list_qtype qtype, async_instance_t *aid,
                                  H5VL_async_t *parent_obj,
                                  const H5VL_loc_params_t *loc_params,
                                  H5VL_attr_specific_args_t *spec_args,
                                  hid_t dxpl_id, void **req) {
  async_task_t *async_task = NULL;
  ...
  if ((args = (async_attr_specific_args_t *)calloc(
           1, sizeof(async_attr_specific_args_t))) == NULL) {
    fprintf(fout_g, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
    goto error;
  }
  /* create a new task and insert into its file task list */
...
static void async_attr_optional_fn(void *foo) {
  ...
  /* Try executing operation, without default error stack handling */
  H5E_BEGIN_TRY {
    status = H5VLattr_optional(args->obj, task->under_vol_id, &args->args,
                               args->dxpl_id, NULL);
    check_app_wait(attempt_count, __func__);
  }
  H5E_END_TRY
...
static herr_t async_attr_optional(task_list_qtype qtype, async_instance_t *aid,
                                  H5VL_async_t *parent_obj,
                                  H5VL_optional_args_t *opt_args, hid_t dxpl_id,
                                  void **req) {
  async_task_t *async_task = NULL;
  ...
  if ((args = (async_attr_optional_args_t *)calloc(
           1, sizeof(async_attr_optional_args_t))) == NULL) {
    fprintf(fout_g, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
    goto error;
  }
  /* create a new task and insert into its file task list */
...
static void async_attr_close_fn(void *foo) {
  ...
  H5E_BEGIN_TRY {
    status =
        H5VLattr_close(args->attr, task->under_vol_id, args->dxpl_id, NULL);
    check_app_wait(attempt_count, __func__);
  }
  H5E_END_TRY
  if (status < 0) {
...
static herr_t async_attr_close(task_list_qtype qtype, async_instance_t *aid,
                               H5VL_async_t *parent_obj, hid_t dxpl_id,
                               void **req) {
  async_task_t *async_task = NULL;
  ...
  if ((args = (async_attr_close_args_t *)calloc(
           1, sizeof(async_attr_close_args_t))) == NULL) {
    fprintf(fout_g, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
    goto error;
  }
  /* create a new task and insert into its file task list */
...
static void async_dataset_create_fn(void *foo) {
  ...
  ABT_pool *pool_ptr;
  async_task_t *task = (async_task_t *)foo;
  async_dataset_create_args_t *args =
      (async_dataset_create_args_t *)(task->args);
  ...
  /* Try executing operation, without default error stack handling */
  H5E_BEGIN_TRY {
    obj = H5VLdataset_create(args->obj, args->loc_params, task->under_vol_id,
                             args->name, args->lcpl_id, args->type_id,
                             args->space_id, args->dcpl_id, args->dapl_id,
                             args->dxpl_id, NULL);
...
static H5VL_async_t *
async_dataset_create(async_instance_t *aid, H5VL_async_t *parent_obj,
                     const H5VL_loc_params_t *loc_params, const char *name,
  ...
  if ((args = (async_dataset_create_args_t *)calloc(
           1, sizeof(async_dataset_create_args_t))) == NULL) {
    fprintf(fout_g, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
    goto error;
  }
  /* create a new async object */
  ...
  if (sizeof(*loc_params) > 0) {
    ...
    args->loc_params =
        (H5VL_loc_params_t *)calloc(1, sizeof(H5VL_loc_params_t));
  if (NULL != name)
    args->name = strdup(name);
  if (lcpl_id > 0)
...
static void async_dataset_open_fn(void *foo) {
  ...
  /* Try executing operation, without default error stack handling */
  H5E_BEGIN_TRY {
    obj = H5VLdataset_open(args->obj, args->loc_params, task->under_vol_id,
                           args->name, args->dapl_id, args->dxpl_id, NULL);
    check_app_wait(attempt_count + 3, __func__);
  }
  H5E_END_TRY
  if (NULL == obj) {
...
static H5VL_async_t *async_dataset_open(task_list_qtype qtype,
                                        async_instance_t *aid,
                                        H5VL_async_t *parent_obj,
                                        const H5VL_loc_params_t *loc_params,
                                        const char *name, hid_t dapl_id,
  ...
  if ((args = (async_dataset_open_args_t *)calloc(
           1, sizeof(async_dataset_open_args_t))) == NULL) {
    fprintf(fout_g, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
    goto error;
  }
  /* create a new async object */
  ...
  if (parent_obj->file_async_obj &&
      parent_obj->file_async_obj->file_task_list_mutex) {
    if (ABT_mutex_lock(parent_obj->file_async_obj->file_task_list_mutex) !=
        ABT_SUCCESS) {
      fprintf(fout_g, "  [ASYNC VOL ERROR] %s with ABT_mutex_lock\n", __func__);
      goto done;
...
static void async_dataset_read_fn(void *foo) {
  ...
  /* Try executing operation, without default error stack handling */
  H5E_BEGIN_TRY {
    status = H5VLdataset_read(args->dset, task->under_vol_id, args->mem_type_id,
                              args->mem_space_id, args->file_space_id,
                              args->plist_id, args->buf, NULL);
...
static herr_t async_dataset_read(async_instance_t *aid,
                                 H5VL_async_t *parent_obj, hid_t mem_type_id,
                                 hid_t mem_space_id, hid_t file_space_id,
                                 hid_t plist_id, void *buf, void **req) {
  // For implicit mode (env var), make all read to be blocking
  assert(async_instance_g);
  ...
  if ((args = (async_dataset_read_args_t *)calloc(
           1, sizeof(async_dataset_read_args_t))) == NULL) {
    fprintf(fout_g, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
    goto error;
  }
  /* create a new task and insert into its file task list */
...
static void async_dataset_write_fn(void *foo) {
  ...
  while (1) {
    if (count > 10000) {
      fprintf(fout_g,
              "  [ASYNC ABT DBG] %s cannot acquire object lock in 10s!\n",
              __func__);
      break;
    }
  ...
  /* Try executing operation, without default error stack handling */
  H5E_BEGIN_TRY {
    status = H5VLdataset_write(
        args->dset, task->under_vol_id, args->mem_type_id, args->mem_space_id,
...
static herr_t async_dataset_write(async_instance_t *aid,
                                  H5VL_async_t *parent_obj, hid_t mem_type_id,
                                  hid_t mem_space_id, hid_t file_space_id,
  ...
  if ((args = (async_dataset_write_args_t *)calloc(
           1, sizeof(async_dataset_write_args_t))) == NULL) {
    fprintf(fout_g, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
    goto error;
  }
  /* create a new task and insert into its file task list */
  ...
  if (async_instance_g->used_mem + buf_size > async_instance_g->max_mem) {
    ...
    args->buf = (void *)buf;
    fprintf(fout_g,
            "  [ASYNC ABT INFO] %d write size %lu larger than async memory "
            "limit %lu, switch to "
            "synchronous write\n",
    ...
    args->buf = (void *)buf;
    fprintf(fout_g,
            "  [ASYNC ABT INFO] %d write size %lu larger than available memory "
            "%lu, switch to "
            "synchronous write\n",
    ...
    if (1 != is_contig_memspace(mem_space_id)) {
      ...
      H5Dgather(mem_space_id, buf, mem_type_id, buf_size, args->buf, NULL,
                NULL);
...
static void async_dataset_get_fn(void *foo) {
  ...
  /* Try executing operation, without default error stack handling */
  H5E_BEGIN_TRY {
    status = H5VLdataset_get(args->dset, task->under_vol_id, &args->args,
                             args->dxpl_id, NULL);
    check_app_wait(attempt_count, __func__);
  }
  H5E_END_TRY
...
static herr_t async_dataset_get(task_list_qtype qtype, async_instance_t *aid,
                                H5VL_async_t *parent_obj,
  ...
  if ((args = (async_dataset_get_args_t *)calloc(
           1, sizeof(async_dataset_get_args_t))) == NULL) {
    fprintf(fout_g, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
    goto error;
  }
  /* create a new task and insert into its file task list */
  ...
  if (dup_dataset_get_args(&args->args, get_args, async_task) < 0) {
    fprintf(fout_g,
            "  [ASYNC VOL ERROR] %s with duplicating dataset get arguments\n",
            __func__);
    goto error;
  }
  if (dxpl_id > 0)
...
static void async_dataset_specific_fn(void *foo) {
  ...
  ABT_pool *pool_ptr;
  async_task_t *task = (async_task_t *)foo;
  async_dataset_specific_args_t *args =
      (async_dataset_specific_args_t *)(task->args);
  herr_t status;
  ...
  /* Try executing operation, without default error stack handling */
  H5E_BEGIN_TRY {
    status = H5VLdataset_specific(args->obj, task->under_vol_id, &args->args,
                                  args->dxpl_id, NULL);
    check_app_wait(attempt_count, __func__);
  }
  H5E_END_TRY
...
static herr_t async_dataset_specific(task_list_qtype qtype,
                                     async_instance_t *aid,
                                     H5VL_async_t *parent_obj,
                                     H5VL_dataset_specific_args_t *spec_args,
                                     hid_t dxpl_id, void **req) {
  async_task_t *async_task = NULL;
...
static void async_dataset_optional_fn(void *foo) {
  ...
  ABT_pool *pool_ptr;
  async_task_t *task = (async_task_t *)foo;
  async_dataset_optional_args_t *args =
      (async_dataset_optional_args_t *)(task->args);
  herr_t status;
  ...
  /* Try executing operation, without default error stack handling */
  H5E_BEGIN_TRY {
    status = H5VLdataset_optional(args->obj, task->under_vol_id, &args->args,
                                  args->dxpl_id, NULL);
    check_app_wait(attempt_count, __func__);
  }
  H5E_END_TRY
...
static herr_t async_dataset_optional(task_list_qtype qtype,
                                     async_instance_t *aid,
                                     H5VL_async_t *parent_obj,
...
static void async_dataset_close_fn(void *foo) {
  ...
  H5E_BEGIN_TRY {
    status =
        H5VLdataset_close(args->dset, task->under_vol_id, args->dxpl_id, NULL);
    check_app_wait(attempt_count + 3, __func__);
  }
  H5E_END_TRY
  if (status < 0) {
...
static herr_t async_dataset_close(task_list_qtype qtype, async_instance_t *aid,
                                  H5VL_async_t *parent_obj, hid_t dxpl_id,
                                  void **req) {
  async_task_t *async_task = NULL;
  ...
  if ((args = (async_dataset_close_args_t *)calloc(
           1, sizeof(async_dataset_close_args_t))) == NULL) {
    fprintf(fout_g, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
    goto error;
  }
  /* create a new task and insert into its file task list */
...
static void async_datatype_commit_fn(void *foo) {
  ...
  ABT_pool *pool_ptr;
  async_task_t *task = (async_task_t *)foo;
  async_datatype_commit_args_t *args =
      (async_datatype_commit_args_t *)(task->args);
  void *under_obj;
  ...
  H5E_BEGIN_TRY {
    under_obj =
        H5VLdatatype_commit(args->obj, args->loc_params, task->under_vol_id,
                            args->name, args->type_id, args->lcpl_id,
                            args->tcpl_id, args->tapl_id, args->dxpl_id, NULL);
    check_app_wait(attempt_count, __func__);
  }
  H5E_END_TRY
  if (NULL == under_obj) {
...
static H5VL_async_t *
async_datatype_commit(async_instance_t *aid, H5VL_async_t *parent_obj,
                      const H5VL_loc_params_t *loc_params, const char *name,
...
static void async_datatype_open_fn(void *foo) {
  ...
  /* Try executing operation, without default error stack handling */
  H5E_BEGIN_TRY {
    obj = H5VLdatatype_open(args->obj, args->loc_params, task->under_vol_id,
                            args->name, args->tapl_id, args->dxpl_id, NULL);
    check_app_wait(attempt_count, __func__);
  }
  H5E_END_TRY
  if (NULL == obj) {
...
static H5VL_async_t *async_datatype_open(async_instance_t *aid,
                                         H5VL_async_t *parent_obj,
                                         const H5VL_loc_params_t *loc_params,
                                         const char *name, hid_t tapl_id,
                                         hid_t dxpl_id, void **req) {
  ...
  if ((args = (async_datatype_open_args_t *)calloc(
           1, sizeof(async_datatype_open_args_t))) == NULL) {
    fprintf(fout_g, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
    goto error;
  }
  /* create a new async object */
...
static void async_datatype_get_fn(void *foo) {
  ...
  /* Try executing operation, without default error stack handling */
  H5E_BEGIN_TRY {
    status = H5VLdatatype_get(args->dt, task->under_vol_id, &args->args,
                              args->dxpl_id, NULL);
    check_app_wait(attempt_count, __func__);
  }
  H5E_END_TRY
...
static herr_t async_datatype_get(task_list_qtype qtype, async_instance_t *aid,
                                 H5VL_async_t *parent_obj,
                                 H5VL_datatype_get_args_t *get_args,
                                 hid_t dxpl_id, void **req) {
  async_task_t *async_task = NULL;
  ...
  if ((args = (async_datatype_get_args_t *)calloc(
           1, sizeof(async_datatype_get_args_t))) == NULL) {
    fprintf(fout_g, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
    goto error;
  }
  /* create a new task and insert into its file task list */
  ...
  if (dup_datatype_get_args(&args->args, get_args, async_task) < 0) {
    fprintf(fout_g,
            "  [ASYNC VOL ERROR] %s with duplicating datatype get arguments\n",
            __func__);
    goto error;
  }
  if (dxpl_id > 0)
...
static void async_datatype_specific_fn(void *foo) {
  ...
  ABT_pool *pool_ptr;
  async_task_t *task = (async_task_t *)foo;
  async_datatype_specific_args_t *args =
      (async_datatype_specific_args_t *)(task->args);
  herr_t status;
  ...
  /* Try executing operation, without default error stack handling */
  H5E_BEGIN_TRY {
    status = H5VLdatatype_specific(args->obj, task->under_vol_id, &args->args,
                                   args->dxpl_id, NULL);
    check_app_wait(attempt_count, __func__);
  }
  H5E_END_TRY
...
static herr_t async_datatype_specific(task_list_qtype qtype,
                                      async_instance_t *aid,
                                      H5VL_async_t *parent_obj,
                                      H5VL_datatype_specific_args_t *spec_args,
                                      hid_t dxpl_id, void **req) {
  async_task_t *async_task = NULL;
...
static void async_datatype_optional_fn(void *foo) {
  ...
  ABT_pool *pool_ptr;
  async_task_t *task = (async_task_t *)foo;
  async_datatype_optional_args_t *args =
      (async_datatype_optional_args_t *)(task->args);
  herr_t status;
  ...
  /* Try executing operation, without default error stack handling */
  H5E_BEGIN_TRY {
    status = H5VLdatatype_optional(args->obj, task->under_vol_id, &args->args,
                                   args->dxpl_id, NULL);
    check_app_wait(attempt_count, __func__);
  }
  H5E_END_TRY
...
static herr_t async_datatype_optional(task_list_qtype qtype,
                                      async_instance_t *aid,
                                      H5VL_async_t *parent_obj,
                                      H5VL_optional_args_t *opt_args,
                                      hid_t dxpl_id, void **req) {
...
static void async_datatype_close_fn(void *foo) {
  ...
  ABT_pool *pool_ptr;
  async_task_t *task = (async_task_t *)foo;
  async_datatype_close_args_t *args =
      (async_datatype_close_args_t *)(task->args);
  herr_t status;
  ...
  H5E_BEGIN_TRY {
    status =
        H5VLdatatype_close(args->dt, task->under_vol_id, args->dxpl_id, NULL);
    check_app_wait(attempt_count, __func__);
  }
  H5E_END_TRY
  if (status < 0) {
...
static herr_t async_datatype_close(task_list_qtype qtype, async_instance_t *aid,
                                   H5VL_async_t *parent_obj, hid_t dxpl_id,
                                   void **req) {
  async_task_t *async_task = NULL;
  ...
  if ((args = (async_datatype_close_args_t *)calloc(
           1, sizeof(async_datatype_close_args_t))) == NULL) {
    fprintf(fout_g, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
    goto error;
  }
  /* create a new task and insert into its file task list */
...
static void async_file_create_fn(void *foo) {
  ...
  /* herr_t status; */
  hid_t under_vol_id;
  /* uint64_t supported;          /1* Whether 'post open' operation is supported
   * by VOL connector *1/ */
  ...
  /* Try executing operation, without default error stack handling */
  H5E_BEGIN_TRY {
    obj = H5VLfile_create(args->name, args->flags, args->fcpl_id, args->fapl_id,
                          args->dxpl_id, NULL);
  ...
  /* supported = 0; */
  /* if(H5VLintrospect_opt_query(obj, under_vol_id, H5VL_SUBCLS_FILE,
   * H5VL_NATIVE_FILE_POST_OPEN, &supported) < 0) { */
  /*     fprintf(fout_g,"  [ASYNC ABT ERROR] %s H5VLintrospect_opt_query
   * failed\n", __func__); */
  /*     goto done; */
  /* } */
   ...
   */
  /*     H5E_BEGIN_TRY { */
  /*         status = H5VLfile_optional_vararg(obj, under_vol_id,
   * H5VL_NATIVE_FILE_POST_OPEN, args->dxpl_id, NULL); */
  /*     } H5E_END_TRY */
  /*     if ( status < 0 ) { */
  /*         if ((task->err_stack = H5Eget_current_stack()) < 0) */
  /*             fprintf(fout_g,"  [ASYNC ABT ERROR] %s H5Eget_current_stack
   * failed\n", __func__); */
  /*         goto done; */
  /*     } */
  /* } /1* end if *1/ */
...
static H5VL_async_t *async_file_create(async_instance_t *aid, const char *name,
                                       unsigned flags, hid_t fcpl_id,
  ...
  if ((args = (async_file_create_args_t *)calloc(
           1, sizeof(async_file_create_args_t))) == NULL) {
    fprintf(fout_g, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
    goto error;
  }
  /* create a new async object */
  ...
  /* Lock async_obj */
  while (1) {
    if (async_obj->obj_mutex &&
        ABT_mutex_trylock(async_obj->obj_mutex) == ABT_SUCCESS) {
      break;
    } else
  ...
  /* Insert it into the file task list */
  DL_APPEND2(async_obj->file_task_list_head, async_task, file_list_prev,
             file_list_next);
  if (ABT_mutex_unlock(async_obj->file_async_obj->file_task_list_mutex) !=
      ABT_SUCCESS) {
    fprintf(fout_g, "  [ASYNC VOL ERROR] %s with ABT_mutex_unlock\n", __func__);
...
static void async_file_open_fn(void *foo) {
  ...
  /* Try executing operation, without default error stack handling */
  H5E_BEGIN_TRY {
    obj = H5VLfile_open(args->name, args->flags, args->fapl_id, args->dxpl_id,
                        NULL);
    check_app_wait(attempt_count, __func__);
  }
  H5E_END_TRY
  ...
  /* /1* Try executing operation, without default error stack handling *1/ */
  /* H5E_BEGIN_TRY { */
  /*     status = H5VLintrospect_opt_query(obj, under_vol_id, H5VL_SUBCLS_FILE,
   * H5VL_NATIVE_FILE_POST_OPEN, &supported); */
  /* } H5E_END_TRY */
  /* if ( status < 0 ) { */
  /*     if ((task->err_stack = H5Eget_current_stack()) < 0) */
  /*         fprintf(fout_g,"  [ASYNC ABT ERROR] %s H5Eget_current_stack
...
static H5VL_async_t *async_file_open(task_list_qtype qtype,
                                     async_instance_t *aid, const char *name,
  ...
  if ((args = (async_file_open_args_t *)calloc(
           1, sizeof(async_file_open_args_t))) == NULL) {
    fprintf(fout_g, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
    goto error;
  }
  /* create a new async object */
...
static void async_file_get_fn(void *foo) {
  ...
  /* Try executing operation, without default error stack handling */
  H5E_BEGIN_TRY {
    status = H5VLfile_get(args->file, task->under_vol_id, &args->args,
                          args->dxpl_id, NULL);
    check_app_wait(attempt_count, __func__);
  }
  H5E_END_TRY
...
static herr_t async_file_get(task_list_qtype qtype, async_instance_t *aid,
                             H5VL_async_t *parent_obj,
                             H5VL_file_get_args_t *get_args, hid_t dxpl_id,
                             void **req) {
  async_task_t *async_task = NULL;
  ...
  if ((args = (async_file_get_args_t *)calloc(
           1, sizeof(async_file_get_args_t))) == NULL) {
    fprintf(fout_g, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
    goto error;
  }
  /* create a new task and insert into its file task list */
  ...
  if (dup_file_get_args(&args->args, get_args, async_task) < 0) {
    fprintf(fout_g,
            "  [ASYNC VOL ERROR] %s with duplicating file get arguments\n",
            __func__);
    goto error;
  }
  if (dxpl_id > 0)
...
static void async_file_specific_fn(void *foo) {
  ...
  /* Try executing operation, without default error stack handling */
  H5E_BEGIN_TRY {
    status = H5VLfile_specific(args->file, task->under_vol_id, &args->args,
                               args->dxpl_id, NULL);
    check_app_wait(attempt_count, __func__);
  }
  H5E_END_TRY
...
static herr_t async_file_specific(task_list_qtype qtype, async_instance_t *aid,
                                  H5VL_async_t *parent_obj,
                                  H5VL_file_specific_args_t *spec_args,
                                  hid_t dxpl_id, void **req) {
  async_task_t *async_task = NULL;
  ...
  if ((args = (async_file_specific_args_t *)calloc(
           1, sizeof(async_file_specific_args_t))) == NULL) {
    fprintf(fout_g, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
    goto error;
  }
  /* create a new task and insert into its file task list */
  ...
  if (parent_obj->file_async_obj &&
      ABT_mutex_lock(parent_obj->file_async_obj->file_task_list_mutex) !=
          ABT_SUCCESS) {
    fprintf(fout_g, "  [ASYNC VOL ERROR] %s with ABT_mutex_lock\n", __func__);
    goto done;
  }
  ...
  DL_APPEND2(parent_obj->file_task_list_head, async_task, file_list_prev,
             file_list_next);
  if (parent_obj->file_async_obj &&
      ABT_mutex_unlock(parent_obj->file_async_obj->file_task_list_mutex) !=
          ABT_SUCCESS) {
    fprintf(fout_g, "  [ASYNC VOL ERROR] %s with ABT_mutex_unlock\n", __func__);
    goto done;
  }
...
static void async_file_optional_fn(void *foo) {
  ...
  /* Try executing operation, without default error stack handling */
  H5E_BEGIN_TRY {
    status = H5VLfile_optional(args->file, task->under_vol_id, &args->args,
                               args->dxpl_id, NULL);
    check_app_wait(attempt_count + 4, __func__);
  }
  H5E_END_TRY
...
static herr_t async_file_optional(task_list_qtype qtype, async_instance_t *aid,
                                  H5VL_async_t *parent_obj,
                                  H5VL_optional_args_t *opt_args, hid_t dxpl_id,
                                  void **req) {
  async_task_t *async_task = NULL;
  ...
  if ((args = (async_file_optional_args_t *)calloc(
           1, sizeof(async_file_optional_args_t))) == NULL) {
    fprintf(fout_g, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
    goto error;
  }
  /* create a new task and insert into its file task list */
...
static void async_file_close_fn(void *foo) {
  ...
  H5E_BEGIN_TRY {
    status =
        H5VLfile_close(args->file, task->under_vol_id, args->dxpl_id, NULL);
    check_app_wait(attempt_count, __func__);
  }
  H5E_END_TRY
  if (status < 0) {
...
static herr_t async_file_close(task_list_qtype qtype, async_instance_t *aid,
                               H5VL_async_t *parent_obj, hid_t dxpl_id,
                               void **req) {
  async_task_t *async_task = NULL;
  ...
  if ((args = (async_file_close_args_t *)calloc(
           1, sizeof(async_file_close_args_t))) == NULL) {
    fprintf(fout_g, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
    goto error;
  }
  /* create a new task and insert into its file task list */
  ...
  if (parent_obj->obj_mutex &&
      ABT_mutex_unlock(parent_obj->obj_mutex) != ABT_SUCCESS) {
    fprintf(fout_g, "  [ASYNC VOL ERROR] %s with ABT_mutex_unlock\n", __func__);
    goto error;
  }
  lock_parent = false;
...
static void async_group_create_fn(void *foo) {
  ...
  /* Try executing operation, without default error stack handling */
  H5E_BEGIN_TRY {
    obj = H5VLgroup_create(args->obj, args->loc_params, task->under_vol_id,
                           args->name, args->lcpl_id, args->gcpl_id,
                           args->gapl_id, args->dxpl_id, NULL);
    check_app_wait(attempt_count + 3, __func__);
  }
  H5E_END_TRY
  if (NULL == obj) {
...
static H5VL_async_t *async_group_create(async_instance_t *aid,
                                        H5VL_async_t *parent_obj,
                                        const H5VL_loc_params_t *loc_params,
                                        const char *name, hid_t lcpl_id,
                                        hid_t gcpl_id, hid_t gapl_id,
  ...
  if ((args = (async_group_create_args_t *)calloc(
           1, sizeof(async_group_create_args_t))) == NULL) {
    fprintf(fout_g, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
    goto error;
  }
  /* create a new async object */
...
error:
  ...
  if (NULL != async_task->h5_state &&
      H5VLfree_lib_state(async_task->h5_state) < 0)
    fprintf(fout_g, "  [ASYNC ABT ERROR] %s H5VLfree_lib_state failed\n",
            __func__);
...
static void async_group_open_fn(void *foo) {
  ...
  /* Try executing operation, without default error stack handling */
  H5E_BEGIN_TRY {
    obj = H5VLgroup_open(args->obj, args->loc_params, task->under_vol_id,
                         args->name, args->gapl_id, args->dxpl_id, NULL);
    check_app_wait(attempt_count + 3, __func__);
  }
  H5E_END_TRY
  if (NULL == obj) {
...
static H5VL_async_t *async_group_open(async_instance_t *aid,
                                      H5VL_async_t *parent_obj,
                                      const H5VL_loc_params_t *loc_params,
                                      const char *name, hid_t gapl_id,
                                      hid_t dxpl_id, void **req) {
  ...
  if ((args = (async_group_open_args_t *)calloc(
           1, sizeof(async_group_open_args_t))) == NULL) {
    fprintf(fout_g, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
    goto error;
  }
  /* create a new async object */
...
static void async_group_get_fn(void *foo) {
  ...
  /* Try executing operation, without default error stack handling */
  H5E_BEGIN_TRY {
    status = H5VLgroup_get(args->obj, task->under_vol_id, &args->args,
                           args->dxpl_id, NULL);
    check_app_wait(attempt_count, __func__);
  }
  H5E_END_TRY
...
static herr_t async_group_get(task_list_qtype qtype, async_instance_t *aid,
                              H5VL_async_t *parent_obj,
                              H5VL_group_get_args_t *get_args, hid_t dxpl_id,
                              void **req) {
  async_task_t *async_task = NULL;
  ...
  if ((args = (async_group_get_args_t *)calloc(
           1, sizeof(async_group_get_args_t))) == NULL) {
    fprintf(fout_g, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
    goto error;
  }
  /* create a new task and insert into its file task list */
  ...
  if (dup_group_get_args(&args->args, get_args, async_task) < 0) {
    fprintf(fout_g,
            "  [ASYNC VOL ERROR] %s with duplicating group get arguments\n",
            __func__);
    goto error;
  }
  if (dxpl_id > 0)
...
static void async_group_specific_fn(void *foo) {
  ...
  ABT_pool *pool_ptr;
  async_task_t *task = (async_task_t *)foo;
  async_group_specific_args_t *args =
      (async_group_specific_args_t *)(task->args);
  herr_t status;
  ...
  /* Try executing operation, without default error stack handling */
  H5E_BEGIN_TRY {
    status = H5VLgroup_specific(args->obj, task->under_vol_id, &args->args,
                                args->dxpl_id, NULL);
    check_app_wait(attempt_count, __func__);
  }
  H5E_END_TRY
...
static herr_t async_group_specific(task_list_qtype qtype, async_instance_t *aid,
                                   H5VL_async_t *parent_obj,
                                   H5VL_group_specific_args_t *spec_args,
                                   hid_t dxpl_id, void **req) {
  async_task_t *async_task = NULL;
  ...
  if ((args = (async_group_specific_args_t *)calloc(
           1, sizeof(async_group_specific_args_t))) == NULL) {
    fprintf(fout_g, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
    goto error;
  }
  /* create a new task and insert into its file task list */
...
static void async_group_optional_fn(void *foo) {
  ...
  ABT_pool *pool_ptr;
  async_task_t *task = (async_task_t *)foo;
  async_group_optional_args_t *args =
      (async_group_optional_args_t *)(task->args);
  herr_t status;
  ...
  /* Try executing operation, without default error stack handling */
  H5E_BEGIN_TRY {
    status = H5VLgroup_optional(args->obj, task->under_vol_id, &args->args,
                                args->dxpl_id, NULL);
    check_app_wait(attempt_count, __func__);
  }
  H5E_END_TRY
...
static herr_t async_group_optional(task_list_qtype qtype, async_instance_t *aid,
                                   H5VL_async_t *parent_obj,
                                   H5VL_optional_args_t *opt_args,
                                   hid_t dxpl_id, void **req) {
  async_task_t *async_task = NULL;
  ...
  if ((args = (async_group_optional_args_t *)calloc(
           1, sizeof(async_group_optional_args_t))) == NULL) {
    fprintf(fout_g, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
    goto error;
  }
  /* create a new task and insert into its file task list */
...
static void async_group_close_fn(void *foo) {
  ...
  // There may be cases, e.g. with link iteration, that enters group close
  // without a valid async_obj mutex
  ...
  H5E_BEGIN_TRY {
    status =
        H5VLgroup_close(args->grp, task->under_vol_id, args->dxpl_id, NULL);
    check_app_wait(attempt_count + 3, __func__);
  }
  H5E_END_TRY
  if (status < 0) {
...
static herr_t async_group_close(task_list_qtype qtype, async_instance_t *aid,
                                H5VL_async_t *parent_obj, hid_t dxpl_id,
                                void **req) {
  async_task_t *async_task = NULL;
  ...
  if ((args = (async_group_close_args_t *)calloc(
           1, sizeof(async_group_close_args_t))) == NULL) {
    fprintf(fout_g, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
    goto error;
  }
  /* create a new task and insert into its file task list */
...
static void async_link_create_fn(void *foo) {
  ...
  /* Try executing operation, without default error stack handling */
  H5E_BEGIN_TRY {
    status = H5VLlink_create(&args->args, args->obj, args->loc_params,
                             task->under_vol_id, args->lcpl_id, args->lapl_id,
                             args->dxpl_id, NULL);
    check_app_wait(attempt_count, __func__);
  }
  H5E_END_TRY
...
herr_t async_link_create(task_list_qtype qtype, async_instance_t *aid,
  ...
  if ((args = (async_link_create_args_t *)calloc(
           1, sizeof(async_link_create_args_t))) == NULL) {
    fprintf(fout_g, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
    goto error;
  }
  /* create a new async object */
...
static void async_link_copy_fn(void *foo) {
  ...
  /*         } */
  /* #ifdef ENABLE_DBG_MSG */
  /*         fprintf(fout_g,"  [ASYNC ABT ERROR] %s parent object is NULL,
   * re-insert to pool\n", __func__);
   */
  /* #endif */
  /*         if (ABT_thread_create(*task->async_obj->pool_ptr, task->func, task,
   * ABT_THREAD_ATTR_NULL, &task->abt_thread) != ABT_SUCCESS) { */
  /*             fprintf(fout_g,"  [ASYNC ABT ERROR] %s ABT_thread_create failed
   * for %p\n", __func__, task->func); */
  /*         } */
  ...
  /* Try executing operation, without default error stack handling */
  H5E_BEGIN_TRY {
    status = H5VLlink_copy(args->src_obj, args->loc_params1, args->dst_obj,
                           args->loc_params2, task->under_vol_id, args->lcpl_id,
...
static herr_t async_link_copy(async_instance_t *aid, H5VL_async_t *parent_obj1,
  ...
  if ((args = (async_link_copy_args_t *)calloc(
           1, sizeof(async_link_copy_args_t))) == NULL) {
    fprintf(fout_g, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
    goto error;
  }
  /* create a new task and insert into its file task list */
  ...
  if (loc_params1->type == H5VL_OBJECT_BY_NAME &&
      loc_params1->loc_data.loc_by_name.lapl_id < 0) {
    fprintf(fout_g, "  [ASYNC VOL ERROR] %s with 1 loc_by_name.lapl_id\n",
            __func__);
    goto error;
  }
  if (loc_params1->type == H5VL_OBJECT_BY_IDX &&
      loc_params1->loc_data.loc_by_idx.lapl_id < 0) {
    fprintf(fout_g, "  [ASYNC VOL ERROR] %s with 1 loc_by_idx.lapl_id\n",
            __func__);
    goto error;
  }
  if (loc_params2->type == H5VL_OBJECT_BY_NAME &&
      loc_params2->loc_data.loc_by_name.lapl_id < 0) {
    fprintf(fout_g, "  [ASYNC VOL ERROR] %s with 2 loc_by_name.lapl_id\n",
            __func__);
    goto error;
  }
  if (loc_params2->type == H5VL_OBJECT_BY_IDX &&
      loc_params2->loc_data.loc_by_idx.lapl_id < 0) {
...
static void async_link_move_fn(void *foo) {
  ...
  /* Try executing operation, without default error stack handling */
  H5E_BEGIN_TRY {
    status = H5VLlink_move(args->src_obj, args->loc_params1, args->dst_obj,
                           args->loc_params2, task->under_vol_id, args->lcpl_id,
                           args->lapl_id, args->dxpl_id, NULL);
    check_app_wait(attempt_count, __func__);
  }
...
static herr_t async_link_move(async_instance_t *aid, H5VL_async_t *parent_obj1,
                              const H5VL_loc_params_t *loc_params1,
                              H5VL_async_t *parent_obj2,
                              const H5VL_loc_params_t *loc_params2,
                              hid_t lcpl_id, hid_t lapl_id, hid_t dxpl_id,
  ...
  if ((args = (async_link_move_args_t *)calloc(
           1, sizeof(async_link_move_args_t))) == NULL) {
    fprintf(fout_g, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
    goto error;
  }
  /* create a new task and insert into its file task list */
...
static void async_link_get_fn(void *foo) {
  ...
  /* Try executing operation, without default error stack handling */
  H5E_BEGIN_TRY {
    status = H5VLlink_get(args->obj, args->loc_params, task->under_vol_id,
                          &args->args, args->dxpl_id, NULL);
    check_app_wait(attempt_count, __func__);
  }
  H5E_END_TRY
...
static herr_t async_link_get(task_list_qtype qtype, async_instance_t *aid,
                             H5VL_async_t *parent_obj,
                             const H5VL_loc_params_t *loc_params,
                             H5VL_link_get_args_t *get_args, hid_t dxpl_id,
                             void **req) {
  async_task_t *async_task = NULL;
  ...
  if ((args = (async_link_get_args_t *)calloc(
           1, sizeof(async_link_get_args_t))) == NULL) {
    fprintf(fout_g, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
    goto error;
  }
  /* create a new task and insert into its file task list */
...
static void async_link_specific_fn(void *foo) {
  ...
  /* Try executing operation, without default error stack handling */
  H5E_BEGIN_TRY {
    status = H5VLlink_specific(args->obj, args->loc_params, task->under_vol_id,
                               &args->args, args->dxpl_id, NULL);
    check_app_wait(attempt_count, __func__);
  }
  H5E_END_TRY
...
static herr_t async_link_specific(task_list_qtype qtype, async_instance_t *aid,
                                  H5VL_async_t *parent_obj,
                                  const H5VL_loc_params_t *loc_params,
                                  H5VL_link_specific_args_t *spec_args,
                                  hid_t dxpl_id, void **req) {
  async_task_t *async_task = NULL;
  ...
  if ((args = (async_link_specific_args_t *)calloc(
           1, sizeof(async_link_specific_args_t))) == NULL) {
    fprintf(fout_g, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
    goto error;
  }
  /* create a new task and insert into its file task list */
...
static void async_link_optional_fn(void *foo) {
  ...
  /* Try executing operation, without default error stack handling */
  H5E_BEGIN_TRY {
    status = H5VLlink_optional(args->obj, args->loc_params, task->under_vol_id,
                               &args->args, args->dxpl_id, NULL);
    check_app_wait(attempt_count, __func__);
  }
  H5E_END_TRY
...
static herr_t async_link_optional(task_list_qtype qtype, async_instance_t *aid,
                                  H5VL_async_t *parent_obj,
                                  const H5VL_loc_params_t *loc_params,
                                  H5VL_optional_args_t *opt_args, hid_t dxpl_id,
                                  void **req) {
  ...
  if ((args = (async_link_optional_args_t *)calloc(
           1, sizeof(async_link_optional_args_t))) == NULL) {
    fprintf(fout_g, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
    goto error;
  }
  /* create a new task and insert into its file task list */
...
static void async_object_open_fn(void *foo) {
  ...
  /* Try executing operation, without default error stack handling */
  H5E_BEGIN_TRY {
    obj = H5VLobject_open(args->obj, args->loc_params, task->under_vol_id,
                          args->opened_type, args->dxpl_id, NULL);
    check_app_wait(attempt_count, __func__);
  }
  H5E_END_TRY
  if (NULL == obj) {
...
static H5VL_async_t *
async_object_open(task_list_qtype qtype, async_instance_t *aid,
                  H5VL_async_t *parent_obj, const H5VL_loc_params_t *loc_params,
  ...
  if ((args = (async_object_open_args_t *)calloc(
           1, sizeof(async_object_open_args_t))) == NULL) {
    fprintf(fout_g, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
    goto error;
  }
  /* create a new async object */
...
static void async_object_copy_fn(void *foo) {
  ...
  /* Try executing operation, without default error stack handling */
  H5E_BEGIN_TRY {
    status = H5VLobject_copy(
        args->src_obj, args->src_loc_params, args->src_name, args->dst_obj,
        args->dst_loc_params, args->dst_name, task->under_vol_id,
        args->ocpypl_id, args->lcpl_id, args->dxpl_id, NULL);
    check_app_wait(attempt_count, __func__);
  }
  H5E_END_TRY
  if (status < 0) {
...
static herr_t async_object_copy(task_list_qtype qtype, async_instance_t *aid,
                                H5VL_async_t *parent_obj1,
                                const H5VL_loc_params_t *src_loc_params,
                                const char *src_name, H5VL_async_t *parent_obj2,
                                const H5VL_loc_params_t *dst_loc_params,
                                const char *dst_name, hid_t ocpypl_id,
                                hid_t lcpl_id, hid_t dxpl_id, void **req) {
  async_task_t *async_task = NULL;
  ...
  if ((args = (async_object_copy_args_t *)calloc(
           1, sizeof(async_object_copy_args_t))) == NULL) {
    fprintf(fout_g, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
    goto error;
  }
  /* create a new task and insert into its file task list */
  ...
  if (parent_obj1)
    args->src_obj = parent_obj1->under_object;
  args->src_loc_params =
      (H5VL_loc_params_t *)calloc(1, sizeof(*src_loc_params));
  ...
  if (parent_obj2)
    args->dst_obj = parent_obj2->under_object;
  args->dst_loc_params =
      (H5VL_loc_params_t *)calloc(1, sizeof(*dst_loc_params));
...
static void async_object_get_fn(void *foo) {
  ...
  /* Try executing operation, without default error stack handling */
  H5E_BEGIN_TRY {
    status = H5VLobject_get(args->obj, args->loc_params, task->under_vol_id,
                            &args->args, args->dxpl_id, NULL);
    check_app_wait(attempt_count, __func__);
  }
  H5E_END_TRY
...
static herr_t async_object_get(task_list_qtype qtype, async_instance_t *aid,
                               H5VL_async_t *parent_obj,
                               const H5VL_loc_params_t *loc_params,
                               H5VL_object_get_args_t *get_args, hid_t dxpl_id,
                               void **req) {
  async_task_t *async_task = NULL;
  ...
  if ((args = (async_object_get_args_t *)calloc(
           1, sizeof(async_object_get_args_t))) == NULL) {
    fprintf(fout_g, "  [ASYNC VOL ERROR] %s with calloc\n", __func__);
    goto error;
  }
  /* create a new task and insert into its file task list */
  ...
  if (ABT_mutex_lock(parent_obj->file_async_obj->file_task_list_mutex) !=
      ABT_SUCCESS) {
    fprintf(fout_g,
            "  [ASYNC VOL ERROR] %s with ABT_mutex_lock file_task_list_mutex\n",
            __func__);
    goto done;
  }
  /* Insert it into the file task list */
...
static void async_object_specific_fn(void *foo) {
  ...
  ABT_pool *pool_ptr;
  async_task_t *task = (async_task_t *)foo;
  async_object_specific_args_t *args =
      (async_object_specific_args_t *)(task->args);
  herr_t status;
  ...
  H5E_BEGIN_TRY {
    status =
        H5VLobject_specific(args->obj, args->loc_params, task->under_vol_id,
                            &args->args, args->dxpl_id, NULL);
    check_app_wait(attempt_count, __func__);
  }
  H5E_END_TRY
...
static herr_t async_object_specific(task_list_qtype qtype,
                                    async_instance_t *aid,
                                    H5VL_async_t *parent_obj,
                                    const H5VL_loc_params_t *loc_params,
                                    H5VL_object_specific_args_t *spec_args,
                                    hid_t dxpl_id, void **req) {
  async_task_t *async_task = NULL;
...
static void async_object_optional_fn(void *foo) {
  ...
  ABT_pool *pool_ptr;
  async_task_t *task = (async_task_t *)foo;
  async_object_optional_args_t *args =
      (async_object_optional_args_t *)(task->args);
  herr_t status;
  ...
  H5E_BEGIN_TRY {
    status =
        H5VLobject_optional(args->obj, args->loc_params, task->under_vol_id,
                            &args->args, args->dxpl_id, NULL);
    check_app_wait(attempt_count, __func__);
  }
  H5E_END_TRY
...
static herr_t async_object_optional(task_list_qtype qtype,
                                    async_instance_t *aid,
                                    H5VL_async_t *parent_obj,
                                    const H5VL_loc_params_t *loc_params,
                                    H5VL_optional_args_t *opt_args,
 ...
 *---------------------------------------------------------------------------
 */
static herr_t H5VL_async_info_cmp(int *cmp_value, const void *_info1,
                                  const void *_info2) {
...
static herr_t H5VL_async_get_wrap_ctx(const void *obj, void **wrap_ctx) {
  ...
  new_wrap_ctx =
      (H5VL_async_wrap_ctx_t *)calloc(1, sizeof(H5VL_async_wrap_ctx_t));

  if (o_async->under_vol_id > 0) {
    under_vol_id = o_async->under_vol_id;
  } else if (o_async->file_async_obj &&
             o_async->file_async_obj->under_vol_id > 0) {
...
static void *H5VL_async_attr_create(void *obj,
  ...
  if (async_instance_g->disable_implicit_file ||
    ...
    attr = async_attr_create(async_instance_g, o, loc_params, name, type_id,
...
static void *H5VL_async_attr_open(void *obj,
  ...
  if (async_instance_g->disable_implicit_file ||
    ...
    attr = async_attr_open(async_instance_g, o, loc_params, name, aapl_id,
                           dxpl_id, req);
...
static herr_t H5VL_async_attr_read(void *attr, hid_t mem_type_id, void *buf,
  ...
  if (async_instance_g->disable_implicit_file ||
      async_instance_g->disable_implicit) {
    ret_value = H5VLattr_read(o->under_object, o->under_vol_id, mem_type_id,
                              buf, dxpl_id, req);
    ...
    if ((ret_value = async_attr_read(async_instance_g, o, mem_type_id, buf,
                                     dxpl_id, req)) < 0) {
...
static herr_t H5VL_async_attr_write(void *attr, hid_t mem_type_id,
  ...
  if (async_instance_g->disable_implicit_file ||
      async_instance_g->disable_implicit) {
    ret_value = H5VLattr_write(o->under_object, o->under_vol_id, mem_type_id,
                               buf, dxpl_id, req);
    ...
    if ((ret_value = async_attr_write(async_instance_g, o, mem_type_id, buf,
                                      dxpl_id, req)) < 0) {
...
static herr_t H5VL_async_attr_get(void *obj, H5VL_attr_get_args_t *args,
  ...
  if (async_instance_g->disable_implicit_file ||
    ...
    if ((ret_value = async_attr_get(qtype, async_instance_g, o, args, dxpl_id,
                                    req)) < 0)
...
static herr_t H5VL_async_attr_specific(void *obj,
  ...
  if (async_instance_g->disable_implicit_file ||
    ...
    if ((ret_value = async_attr_specific(qtype, async_instance_g, o, loc_params,
                                         args, dxpl_id, req)) < 0)
...
static herr_t H5VL_async_attr_optional(void *obj, H5VL_optional_args_t *args,
  ...
  if (async_instance_g->disable_implicit_file ||
    ...
    if ((ret_value = async_attr_optional(qtype, async_instance_g, o, args,
                                         dxpl_id, req)) < 0)
...
static herr_t H5VL_async_attr_close(void *attr, hid_t dxpl_id, void **req) {
  ...
  if (async_instance_g->disable_implicit_file ||
    ...
    if ((ret_value =
             async_attr_close(qtype, async_instance_g, o, dxpl_id, req)) < 0)
...
static void *H5VL_async_dataset_create(void *obj,
  ...
  if (async_instance_g->disable_implicit_file ||
    ...
    dset =
        async_dataset_create(async_instance_g, o, loc_params, name, lcpl_id,
...
static void *H5VL_async_dataset_open(void *obj,
  ...
  if (async_instance_g->disable_implicit_file ||
    ...
    dset = async_dataset_open(qtype, async_instance_g, o, loc_params, name,
                              dapl_id, dxpl_id, req);
  }
...
static herr_t H5VL_async_dataset_read(void *dset, hid_t mem_type_id,
  ...
  if (async_instance_g->disable_implicit_file ||
    ...
    if ((ret_value =
             async_dataset_read(async_instance_g, o, mem_type_id, mem_space_id,
...
static herr_t H5VL_async_dataset_write(void *dset, hid_t mem_type_id,
  ...
  if (async_instance_g->disable_implicit_file ||
    ...
    if ((ret_value =
             async_dataset_write(async_instance_g, o, mem_type_id, mem_space_id,
                                 file_space_id, plist_id, buf, req)) < 0) {
...
static herr_t H5VL_async_dataset_get(void *dset, H5VL_dataset_get_args_t *args,
  ...
  if (async_instance_g->disable_implicit_file ||
    ...
    if ((ret_value = async_dataset_get(qtype, async_instance_g, o, args,
                                       dxpl_id, req)) < 0)
...
static herr_t H5VL_async_dataset_specific(void *obj,
  ...
  if (async_instance_g->disable_implicit_file ||
    ...
    if ((ret_value = async_dataset_specific(qtype, async_instance_g, o, args,
                                            dxpl_id, req)) < 0)
...
static herr_t H5VL_async_dataset_optional(void *obj, H5VL_optional_args_t *args,
  ...
  if (H5VL_async_dataset_wait_op_g == args->op_type)
    ...
    if (async_instance_g->disable_implicit_file ||
      ...
      if ((ret_value = async_dataset_optional(qtype, async_instance_g, o, args,
                                              dxpl_id, req)) < 0)
...
static herr_t H5VL_async_dataset_close(void *dset, hid_t dxpl_id, void **req) {
  ...
  if (async_instance_g->disable_implicit_file ||
    ...
    if ((ret_value =
             async_dataset_close(qtype, async_instance_g, o, dxpl_id, req)) < 0)
...
static void *H5VL_async_datatype_commit(void *obj,
  ...
  if (async_instance_g->disable_implicit_file ||
    ...
    dt = async_datatype_commit(async_instance_g, o, loc_params, name, type_id,
...
static void *H5VL_async_datatype_open(void *obj,
  ...
  if (async_instance_g->disable_implicit_file ||
      async_instance_g->disable_implicit) {
    under = H5VLdatatype_open(o->under_object, loc_params, o->under_vol_id,
    ...
    dt = async_datatype_open(async_instance_g, o, loc_params, name, tapl_id,
                             dxpl_id, req);
  }
...
static herr_t H5VL_async_datatype_get(void *dt, H5VL_datatype_get_args_t *args,
  ...
  if (async_instance_g->disable_implicit_file ||
    ...
    if ((ret_value = async_datatype_get(qtype, async_instance_g, o, args,
                                        dxpl_id, req)) < 0)
...
static herr_t H5VL_async_datatype_specific(void *obj,
  ...
  if (async_instance_g->disable_implicit_file ||
    ...
    if ((ret_value = async_datatype_specific(qtype, async_instance_g, o, args,
                                             dxpl_id, req)) < 0)
...
static herr_t H5VL_async_datatype_optional(void *obj,
  ...
  if (async_instance_g->disable_implicit_file ||
    ...
    if ((ret_value = async_datatype_optional(qtype, async_instance_g, o, args,
                                             dxpl_id, req)) < 0)
...
static herr_t H5VL_async_datatype_close(void *dt, hid_t dxpl_id, void **req) {
  ...
  if (async_instance_g->disable_implicit_file ||
    ...
    if ((ret_value = async_datatype_close(qtype, async_instance_g, o, dxpl_id,
                                          req)) < 0)
 ...
 */
#ifdef MPI_VERSION
  {
    ...
    if (H5VLintrospect_get_cap_flags(info->under_vol_info, info->under_vol_id,
                                     &cap_flags) < 0)
      return NULL;

    /* Querying for the VFD is only meaninful when using the native VOL
     * connector */
    if ((cap_flags & H5VL_CAP_FLAG_NATIVE_FILES) > 0) {
      ...
      if (H5FD_MPIO == vfd_id) {
        ...
        if (MPI_THREAD_MULTIPLE != mpi_thread_lvl) {
          fprintf(fout_g, "[ASYNC VOL ERROR] MPI is not initialized with "
                          "MPI_THREAD_MULTIPLE!\n");
          return NULL;
        }
      } /* end if */
  ...
  if (async_instance_g->disable_implicit_file ||
    ...
    file = async_file_create(async_instance_g, name, flags, fcpl_id,
                             under_fapl_id, dxpl_id, req);
  }
 ...
 */
  ...
  if (async_instance_g->disable_implicit_file ||
    ...
    /* Open the file with the underlying VOL connector */
    file = async_file_open(qtype, async_instance_g, name, flags, under_fapl_id,
                           dxpl_id, req);
  }
...
static herr_t H5VL_async_file_get(void *file, H5VL_file_get_args_t *args,
  ...
  if (async_instance_g->disable_implicit_file ||
    ...
    if ((ret_value = async_file_get(qtype, async_instance_g, o, args, dxpl_id,
                                    req)) < 0)
...
static herr_t H5VL_async_file_specific(void *file,
  ...
  if (o && !o->is_obj_valid) {
    fprintf(fout_g,
            "  [ASYNC VOL ERROR] with async_file_specific, invalid object\n");
    return (-1);
  }
  ...
  if (args->op_type == H5VL_FILE_IS_ACCESSIBLE ||
    ...
    if (args->op_type == H5VL_FILE_IS_ACCESSIBLE) {
      ...
      new_fapl_id = my_args.args.is_accessible.fapl_id =
    ...
    if ((ret_value = H5VLfile_specific(NULL, info->under_vol_id, &my_args,
                                       dxpl_id, NULL)) < 0)
    ...
    if (async_instance_g->disable_implicit_file ||
        async_instance_g->disable_implicit) {
      ret_value = H5VLfile_specific(o->under_object, o->under_vol_id, args,
                                    dxpl_id, req);
    } else {
      /* Execute all other operations, possibly asynchronously */
      if ((ret_value = async_file_specific(qtype, async_instance_g, o, args,
                                           dxpl_id, req)) < 0)
        fprintf(fout_g, "  [ASYNC VOL ERROR] with async_file_specific\n");
    }
    ...
    if (args->op_type == H5VL_FILE_REOPEN) {
      ...
      if (ret_value >= 0 && *args->args.reopen.file)
        *args->args.reopen.file =
            H5VL_async_new_obj(*args->args.reopen.file, under_vol_id);
    } /* end else-if */
  }   /* end else */
...
static herr_t H5VL_async_file_optional(void *file, H5VL_optional_args_t *args,
  ...
  if (args->op_type == H5VL_async_file_wait_op_g)
    ...
    if (async_instance_g->disable_implicit_file ||
        async_instance_g->disable_implicit) {
      ret_value = H5VLfile_optional(o->under_object, o->under_vol_id, args,
                                    dxpl_id, req);
      ...
      if ((ret_value = async_file_optional(qtype, async_instance_g, o, args,
                                           dxpl_id, req)) < 0)
...
static herr_t H5VL_async_file_close(void *file, hid_t dxpl_id, void **req) {
  ...
  if (async_instance_g->disable_implicit_file ||
    ...
    if ((ret_value =
             async_file_close(qtype, async_instance_g, o, dxpl_id, req)) < 0)
...
static void *H5VL_async_group_create(void *obj,
  ...
  if (async_instance_g->disable_implicit_file ||
    ...
    group = async_group_create(async_instance_g, o, loc_params, name, lcpl_id,
...
static void *H5VL_async_group_open(void *obj,
  ...
  if (async_instance_g->disable_implicit_file ||
    ...
    group = async_group_open(async_instance_g, o, loc_params, name, gapl_id,
                             dxpl_id, req);
  }
...
static herr_t H5VL_async_group_get(void *obj, H5VL_group_get_args_t *args,
  ...
  if (async_instance_g->disable_implicit_file ||
    ...
    if ((ret_value = async_group_get(qtype, async_instance_g, o, args, dxpl_id,
                                     req)) < 0)
...
static herr_t H5VL_async_group_specific(void *obj,
  ...
  if (args->op_type == H5VL_GROUP_MOUNT) {
    ...
    my_args.args.mount.child_file =
        ((H5VL_async_t *)args->args.mount.child_file)->under_object;
  ...
  if (async_instance_g->disable_implicit_file ||
    ...
    ret_value = H5VLgroup_specific(o->under_object, o->under_vol_id, new_args,
                                   dxpl_id, req);
    ...
    if ((ret_value = async_group_specific(qtype, async_instance_g, o, new_args,
                                          dxpl_id, req)) < 0)
...
static herr_t H5VL_async_group_optional(void *obj, H5VL_optional_args_t *args,
  ...
  if (async_instance_g->disable_implicit_file ||
    ...
    if ((ret_value = async_group_optional(qtype, async_instance_g, o, args,
                                          dxpl_id, req)) < 0)
...
static herr_t H5VL_async_group_close(void *grp, hid_t dxpl_id, void **req) {
  ...
  if (async_instance_g->disable_implicit_file ||
    ...
    if ((ret_value =
             async_group_close(qtype, async_instance_g, o, dxpl_id, req)) < 0)
...
static herr_t H5VL_async_link_create(H5VL_link_create_args_t *args, void *obj,
  ...
  if (req == NULL && loc_params && loc_params->obj_type != H5I_BADID && o &&
      !o->is_obj_valid) {
    fprintf(fout_g,
            "  [ASYNC VOL ERROR] with async_file_create, invalid object\n");
    return (-1);
  }
  ...
  if (async_instance_g->disable_implicit_file ||
    ...
    if (H5VL_LINK_CREATE_HARD == args->op_type) {
      ...
      if (args->args.hard.curr_obj) {
        ...
        if (under_vol_id < 0)
          under_vol_id =
              ((H5VL_async_t *)args->args.hard.curr_obj)->under_vol_id;

        /* Set the object for the link target */
        my_args.args.hard.curr_obj =
            ((H5VL_async_t *)args->args.hard.curr_obj)->under_object;
    ...
    if ((ret_value =
             async_link_create(qtype, async_instance_g, args, o, loc_params,
...
H5VL_async_link_copy(void *src_obj, const H5VL_loc_params_t *loc_params1,
  ...
  if (async_instance_g->disable_implicit_file ||
    ...
    if ((ret_value =
             async_link_copy(async_instance_g, o_src, loc_params1, o_dst,
                             loc_params2, lcpl_id, lapl_id, dxpl_id, req)) < 0)
...
H5VL_async_link_move(void *src_obj, const H5VL_loc_params_t *loc_params1,
  ...
  if (async_instance_g->disable_implicit_file ||
    ...
    if ((ret_value =
             async_link_move(async_instance_g, o_src, loc_params1, o_dst,
                             loc_params2, lcpl_id, lapl_id, dxpl_id, req)) < 0)
...
static herr_t H5VL_async_link_get(void *obj,
  ...
  if (async_instance_g->disable_implicit_file ||
    ...
    if ((ret_value = async_link_get(qtype, async_instance_g, o, loc_params,
                                    args, dxpl_id, req)) < 0)
      fprintf(fout_g, "  [ASYNC VOL ERROR] with async_link_move\n");
  }
...
static herr_t H5VL_async_link_specific(void *obj,
  ...
  if (async_instance_g->disable_implicit_file ||
    ...
    if ((ret_value = async_link_specific(qtype, async_instance_g, o, loc_params,
                                         args, dxpl_id, req)) < 0)
...
static herr_t H5VL_async_link_optional(void *obj,
  ...
  if (async_instance_g->disable_implicit_file ||
    ...
    if ((ret_value = async_link_optional(qtype, async_instance_g, o, loc_params,
                                         args, dxpl_id, req)) < 0)
...
static void *H5VL_async_object_open(void *obj,
  ...
  if (async_instance_g->disable_implicit_file ||
    ...
    if (NULL ==
        (new_obj = async_object_open(qtype, async_instance_g, o, loc_params,
                                     opened_type, dxpl_id, req)))
...
static herr_t H5VL_async_object_copy(void *src_obj,
  ...
  if (async_instance_g->disable_implicit_file ||
    ...
    if ((ret_value = async_object_copy(
             qtype, async_instance_g, o_src, src_loc_params, src_name, o_dst,
...
static herr_t H5VL_async_object_get(void *obj,
  ...
  if (async_instance_g->disable_implicit_file ||
      async_instance_g->disable_implicit) {
    ret_value = H5VLobject_get(o->under_object, loc_params, o->under_vol_id,
                               args, dxpl_id, req);
    ...
    if ((ret_value = async_object_get(qtype, async_instance_g, o, loc_params,
                                      args, dxpl_id, req)) < 0)
...
static herr_t H5VL_async_object_specific(void *obj,
  ...
  if (async_instance_g->disable_implicit_file ||
    ...
    ret_value = H5VLobject_specific(o->under_object, loc_params,
    ...
    if ((ret_value = async_object_specific(qtype, async_instance_g, o,
                                           loc_params, args, dxpl_id, req)) < 0)
...
static herr_t H5VL_async_object_optional(void *obj,
  ...
  if (async_instance_g->disable_implicit_file ||
      async_instance_g->disable_implicit) {
    ret_value = H5VLobject_optional(o->under_object, loc_params,
                                    o->under_vol_id, args, dxpl_id, req);
    ...
    if ((ret_value = async_object_optional(qtype, async_instance_g, o,
                                           loc_params, args, dxpl_id, req)) < 0)
 ...
 *-------------------------------------------------------------------------
 */
herr_t H5VL_async_introspect_get_conn_cls(void *obj, H5VL_get_conn_lvl_t lvl,
                                          const H5VL_class_t **conn_cls) {
  H5VL_async_t *o = (H5VL_async_t *)obj;
  herr_t ret_value;
 ...
 *-------------------------------------------------------------------------
 */
herr_t H5VL_async_introspect_get_cap_flags(const void *_info,
                                           unsigned *cap_flags) {
  const H5VL_async_info_t *info = (const H5VL_async_info_t *)_info;
  herr_t ret_value;
 ...
 *-------------------------------------------------------------------------
 */
herr_t H5VL_async_introspect_opt_query(void *obj, H5VL_subclass_t cls,
                                       int opt_type, uint64_t *flags) {
  H5VL_async_t *o = (H5VL_async_t *)obj;
  herr_t ret_value;
 ...
 *-------------------------------------------------------------------------
 */
static herr_t H5VL_async_request_wait(void *obj, uint64_t timeout,
                                      H5VL_request_status_t *status) {
  herr_t ret_value = 0;
  ...
  if (task->async_obj &&
      get_n_running_task_in_queue_obj(task->async_obj) == 0 &&
...
#ifdef ENABLE_DBG_MSG
  if (elapsed > timeout &&
      (async_instance_g && (async_instance_g->mpi_rank == ASYNC_DBG_MSG_RANK ||
                            -1 == ASYNC_DBG_MSG_RANK)))
    fprintf(fout_g,
            "  [ASYNC VOL] timedout during wait (elapsed=%es, timeout=%.1fs)\n",
            elapsed, trigger);
#endif
...
static herr_t H5VL_async_request_specific(void *obj,
  ...
  if (H5VL_REQUEST_GET_ERR_STACK == args->op_type) {
    ...
    *args->args.get_exec_time.exec_time = (uint64_t)(
        (task->end_time - task->start_time) / (CLOCKS_PER_SEC * 1000000000LL));
 ...
 *-------------------------------------------------------------------------
 */
herr_t H5VL_async_blob_put(void *obj, const void *buf, size_t size,
                           void *blob_id, void *ctx) {
  H5VL_async_t *o = (H5VL_async_t *)obj;
  herr_t ret_value;
 ...
 *-------------------------------------------------------------------------
 */
herr_t H5VL_async_blob_get(void *obj, const void *blob_id, void *buf,
                           size_t size, void *ctx) {
  H5VL_async_t *o = (H5VL_async_t *)obj;
  herr_t ret_value;
 ...
 *-------------------------------------------------------------------------
 */
herr_t H5VL_async_blob_specific(void *obj, void *blob_id,
                                H5VL_blob_specific_args_t *args) {
  H5VL_async_t *o = (H5VL_async_t *)obj;
  herr_t ret_value;
 ...
 *-------------------------------------------------------------------------
 */
herr_t H5VL_async_blob_optional(void *obj, void *blob_id,
                                H5VL_optional_args_t *args) {
  H5VL_async_t *o = (H5VL_async_t *)obj;
  herr_t ret_value;
 ...
 *-------------------------------------------------------------------------
 */
herr_t H5VL_async_optional(void *obj, H5VL_optional_args_t *args, hid_t dxpl_id,
                           void **req) {
  H5VL_async_t *o = (H5VL_async_t *)obj;
  herr_t ret_value;
