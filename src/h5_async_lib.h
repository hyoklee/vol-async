...
extern herr_t H5Pset_fapl_disable_async_implicit(hid_t fapl,
                                                 hbool_t is_disable);
extern herr_t H5Pget_fapl_disable_async_implicit(hid_t fapl,
                                                 hbool_t *is_disable);
extern herr_t H5Pset_dxpl_disable_async_implicit(hid_t dxpl,
                                                 hbool_t is_disable);
extern herr_t H5Pget_dxpl_disable_async_implicit(hid_t dxpl,
                                                 hbool_t *is_disable);
