...
int main(int argc, char *argv[]) {
  ...
  for (ifile = 0; ifile < nfile; ifile++) {
    ...
    file_id = H5Fcreate_async(file_name, H5F_ACC_TRUNC, H5P_DEFAULT, async_fapl,
                              es_id);
    if (file_id < 0) {
    ...
    e1 = ((t1.tv_sec - t3.tv_sec) * 1000000 + t1.tv_usec - t3.tv_usec) /
         1000000.0;
    printf("  Observed write dset time: %f\n", e1);

    e2 = ((t3.tv_sec - t2.tv_sec) * 1000000 + t3.tv_usec - t2.tv_usec) /
         1000000.0;
    printf("  Observed write attr time: %f\n", e2);

    e1 = ((t1.tv_sec - t0.tv_sec) * 1000000 + t1.tv_usec - t0.tv_usec) /
         1000000.0;
  ...
  gettimeofday(&te, 0);
  e1 =
      ((te.tv_sec - ts.tv_sec) * 1000000 + te.tv_usec - ts.tv_usec) / 1000000.0;
  e2 =
      ((te.tv_sec - t1.tv_sec) * 1000000 + te.tv_usec - t1.tv_usec) / 1000000.0;
