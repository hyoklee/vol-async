...
int main(int argc, char *argv[]) {
  hid_t file_id, grp_id0, grp_id1, dset1_id, dset0_id, dspace_id, async_dxpl,
      async_fapl;
  ...
  fflush(stdout);
  dset0_id = H5Dcreate(grp_id0, "dset0", H5T_NATIVE_INT, dspace_id, H5P_DEFAULT,
  ...
  fflush(stdout);
  dset1_id = H5Dcreate(grp_id1, "dset1", H5T_NATIVE_INT, dspace_id, H5P_DEFAULT,
                       H5P_DEFAULT, H5P_DEFAULT);
  if (dset1_id < 0) {
