...
int main(int argc, char *argv[]) {
  ...
  for (ifile = 0; ifile < nfile; ifile++) {
    ...
    dset0_id = H5Dcreate(grp_id, "dset0", H5T_NATIVE_INT, dspace_id,
    ...
    dset1_id = H5Dcreate(grp_id, "dset1", H5T_NATIVE_INT, dspace_id,
                         H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT);
    if (dset1_id < 0) {
    ...
    attr0 = H5Acreate(dset0_id, "attr_0", H5T_NATIVE_INT, attr_space,
                      H5P_DEFAULT, H5P_DEFAULT);
    attr1 = H5Acreate(dset1_id, "attr_1", H5T_NATIVE_INT, attr_space,
                      H5P_DEFAULT, H5P_DEFAULT);
