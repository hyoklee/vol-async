...
void create_and_write_synthetic_h5_data(int rank, hid_t loc, hid_t *dset_ids,
  ...
  dset_ids[0] = H5Dcreate_async(loc, "x", H5T_NATIVE_FLOAT, filespace,
                                H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT, es_id);
  dset_ids[1] = H5Dcreate_async(loc, "y", H5T_NATIVE_FLOAT, filespace,
                                H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT, es_id);
  dset_ids[2] = H5Dcreate_async(loc, "z", H5T_NATIVE_FLOAT, filespace,
                                H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT, es_id);
  dset_ids[3] = H5Dcreate_async(loc, "id1", H5T_NATIVE_INT, filespace,
                                H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT, es_id);
  dset_ids[4] = H5Dcreate_async(loc, "id2", H5T_NATIVE_INT, filespace,
                                H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT, es_id);
  dset_ids[5] = H5Dcreate_async(loc, "px", H5T_NATIVE_FLOAT, filespace,
                                H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT, es_id);
  dset_ids[6] = H5Dcreate_async(loc, "py", H5T_NATIVE_FLOAT, filespace,
                                H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT, es_id);
  dset_ids[7] = H5Dcreate_async(loc, "pz", H5T_NATIVE_FLOAT, filespace,
                                H5P_DEFAULT, H5P_DEFAULT, H5P_DEFAULT, es_id);
  ...
  ierr = H5Dwrite_async(dset_ids[3], H5T_NATIVE_INT, memspace, filespace,
                        plist_id, id1, es_id);
  /* if (rank == 0) printf ("Written variable 4 \n"); */

  ierr = H5Dwrite_async(dset_ids[4], H5T_NATIVE_INT, memspace, filespace,
                        plist_id, id2, es_id);
  ...
  ierr = H5Dwrite_async(dset_ids[6], H5T_NATIVE_FLOAT, memspace, filespace,
                        plist_id, py, es_id);
...
int main(int argc, char *argv[]) {
  ...
  hid_t file_id, filespace, memspace, *grp_ids, async_fapl, async_dxpl,
      **dset_ids, es_id;
  char grp_name[128];
  ...
  for (i = 0; i < nts; i++) {
    ...
    grp_ids[i] = H5Gcreate_async(file_id, grp_name, H5P_DEFAULT, H5P_DEFAULT,
                                 H5P_DEFAULT, es_id);
    ...
    create_and_write_synthetic_h5_data(my_rank, grp_ids[i], dset_ids[i],
                                       filespace, memspace, async_dxpl, es_id);
    timer_off(2);
    if (my_rank == 0)
